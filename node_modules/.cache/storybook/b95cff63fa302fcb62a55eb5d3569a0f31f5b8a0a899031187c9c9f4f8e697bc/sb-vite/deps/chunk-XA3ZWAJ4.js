import {
  ...
  ScrollArea,
  SyntaxHighlighter2
} from "./chunk-EMG5LLWJ.js";
import {
  WithToolTipState
} from "./chunk-55S2V4GN.js";
import {
  _extends,
  ...
  newStyled,
  typography
} from "./chunk-YEC22JWI.js";
import {
  O
} from "./chunk-72TGIBAT.js";
import {
...
var Link = ({ href: input, ...props }) => {
  ...
  return import_react.default.createElement("a", { href, target, ...props });
};
...
var Code = ({ className, children, ...props }) => {
  let language = (className || "").match(/lang-(\S+)/), childrenArray = import_react.Children.toArray(children);
  return childrenArray.filter(isReactChildString).some((child) => child.match(isInlineCodeRegex)) ? import_react.default.createElement(StyledSyntaxHighlighter, { bordered: true, copyable: true, language: (language == null ? void 0 : language[1]) ?? "text", format: false, ...props }, children) : import_react.default.createElement(DefaultCodeBlock, { ...props, className }, childrenArray);
};
...
var components = { h1: (props) => import_react.default.createElement(H1, { ...nameSpaceClassNames(props, "h1") }), h2: (props) => import_react.default.createElement(H2, { ...nameSpaceClassNames(props, "h2") }), h3: (props) => import_react.default.createElement(H3, { ...nameSpaceClassNames(props, "h3") }), h4: (props) => import_react.default.createElement(H4, { ...nameSpaceClassNames(props, "h4") }), h5: (props) => import_react.default.createElement(H5, { ...nameSpaceClassNames(props, "h5") }), h6: (props) => import_react.default.createElement(H6, { ...nameSpaceClassNames(props, "h6") }), pre: (props) => import_react.default.createElement(Pre, { ...nameSpaceClassNames(props, "pre") }), a: (props) => import_react.default.createElement(A, { ...nameSpaceClassNames(props, "a") }), hr: (props) => import_react.default.createElement(HR, { ...nameSpaceClassNames(props, "hr") }), dl: (props) => import_react.default.createElement(DL, { ...nameSpaceClassNames(props, "dl") }), blockquote: (props) => import_react.default.createElement(Blockquote, { ...nameSpaceClassNames(props, "blockquote") }), table: (props) => import_react.default.createElement(Table, { ...nameSpaceClassNames(props, "table") }), img: (props) => import_react.default.createElement(Img, { ...nameSpaceClassNames(props, "img") }), div: (props) => import_react.default.createElement(Div, { ...nameSpaceClassNames(props, "div") }), span: (props) => import_react.default.createElement(Span, { ...nameSpaceClassNames(props, "span") }), li: (props) => import_react.default.createElement(LI, { ...nameSpaceClassNames(props, "li") }), ul: (props) => import_react.default.createElement(UL, { ...nameSpaceClassNames(props, "ul") }), ol: (props) => import_react.default.createElement(OL, { ...nameSpaceClassNames(props, "ol") }), p: (props) => import_react.default.createElement(P, { ...nameSpaceClassNames(props, "p") }), code: (props) => import_react.default.createElement(Code, { ...nameSpaceClassNames(props, "code") }), tt: (props) => import_react.default.createElement(TT, { ...nameSpaceClassNames(props, "tt") }), resetwrapper: (props) => import_react.default.createElement(ResetWrapper, { ...nameSpaceClassNames(props, "resetwrapper") }) };
...
var Badge = ({ ...props }) => import_react.default.createElement(BadgeWrapper, { ...props });
var LEFT_BUTTON = 0;
...
var Link2 = ({ cancel = true, children, onClick = void 0, withArrow = false, containsIcon = false, className = void 0, style = void 0, ...rest }) => import_react.default.createElement(A2, { ...rest, onClick: onClick && cancel ? (e) => cancelled(e, onClick) : onClick, className }, import_react.default.createElement(LinkInner, { withArrow, containsIcon }, children, withArrow && import_react.default.createElement(ChevronRightIcon, null)));
...
var languages = [];
var Comp = null;
var LazySyntaxHighlighter = (0, import_react.lazy)(async () => {
  let { SyntaxHighlighter: SyntaxHighlighter3 } = await import("./syntaxhighlighter-JOJW2KGS-WNEF2KWY.js");
  return languages.length > 0 && (languages.forEach((args) => {
    SyntaxHighlighter3.registerLanguage(...args);
  }), languages = []), Comp === null && (Comp = SyntaxHighlighter3), { default: (props) => import_react.default.createElement(SyntaxHighlighter3, { ...props }) };
});
var LazySyntaxHighlighterWithFormatter = (0, import_react.lazy)(async () => {
  let [{ SyntaxHighlighter: SyntaxHighlighter3 }, { formatter }] = await Promise.all([import("./syntaxhighlighter-JOJW2KGS-WNEF2KWY.js"), import("./formatter-B5HCVTEV-3ISIVAOV.js")]);
  return languages.length > 0 && (languages.forEach((args) => {
    SyntaxHighlighter3.registerLanguage(...args);
  }), languages = []), Comp === null && (Comp = SyntaxHighlighter3), { default: (props) => import_react.default.createElement(SyntaxHighlighter3, { ...props, formatter }) };
});
var SyntaxHighlighter22 = (props) => import_react.default.createElement(import_react.Suspense, { fallback: import_react.default.createElement("div", null) }, props.format !== false ? import_react.default.createElement(LazySyntaxHighlighterWithFormatter, { ...props }) : import_react.default.createElement(LazySyntaxHighlighter, { ...props }));
...
var Spaced = ({ col, row, outer, children, ...rest }) => {
  ...
  return import_react.default.createElement(Container, { col, row, outer: outerAmount, ...rest }, children);
};
...
var Placeholder = ({ children, ...props }) => {
  let [title, desc] = import_react.Children.toArray(children);
  return import_react.default.createElement(Message, { ...props }, import_react.default.createElement(Title, null, title), desc && import_react.default.createElement(Desc, null, desc));
};
function useResolvedElement(subscriber, refOrElement) {
  var lastReportRef = (0, import_react.useRef)(null), refOrElementRef = (0, import_react.useRef)(null);
  ...
  }, []), (0, import_react.useCallback)(function(element) {
...
function useResizeObserver(opts) {
  opts === void 0 && (opts = {});
  var onResize = opts.onResize, onResizeRef = (0, import_react.useRef)(void 0);
  onResizeRef.current = onResize;
  var round = opts.round || Math.round, resizeObserverRef = (0, import_react.useRef)(), _useState = (0, import_react.useState)({ width: void 0, height: void 0 }), size = _useState[0], setSize = _useState[1], didUnmount = (0, import_react.useRef)(false);
  (0, import_react.useEffect)(function() {
    return didUnmount.current = false, function() {
      didUnmount.current = true;
    };
  }, []);
  var previous = (0, import_react.useRef)({ width: void 0, height: void 0 }), refCallback = useResolvedElement((0, import_react.useCallback)(function(element) {
...
function ZoomElement({ scale, children }) {
  let componentWrapperRef = (0, import_react.useRef)(null), [elementHeight, setElementHeight] = (0, import_react.useState)(0), onResize = (0, import_react.useCallback)(({ height }) => {
  ...
  }, [scale]), useResizeObserver({ ref: componentWrapperRef, onResize }), import_react.default.createElement(ZoomElementWrapper, { scale, elementHeight }, import_react.default.createElement("div", { ref: componentWrapperRef, className: "innerZoomElementWrapper" }, children));
}
var ZoomIFrame = class extends import_react.Component {
  constructor() {
    super(...arguments);
    this.iframe = null;
  }
...
var ErrorFormatter = ({ error }) => {
  if (!error)
    return import_react.default.createElement(import_react.Fragment, null, "This error has no stack or message");
  if (!error.stack)
    return import_react.default.createElement(import_react.Fragment, null, error.message || "This error has no stack or message");
...
${input}`);
  ...
  if (!match)
    return import_react.default.createElement(import_react.Fragment, null, input);
  ...
  return import_react.default.createElement(import_react.Fragment, null, import_react.default.createElement("span", null, type), ": ", import_react.default.createElement(ErrorName, null, name), import_react.default.createElement("br", null), lines.map((l, i) => l.name ? import_react.default.createElement(import_react.Fragment, { key: i }, "  ", "at ", import_react.default.createElement(ErrorImportant, null, l.name), " (", import_react.default.createElement(ErrorDetail, null, l.location), ")", import_react.default.createElement("br", null)) : import_react.default.createElement(import_react.Fragment, { key: i }, "  ", "at ", import_react.default.createElement(ErrorDetail, null, l.location), import_react.default.createElement("br", null))));
};
var Button = (0, import_react.forwardRef)(({ asChild = false, animation = "none", size = "small", variant = "outline", padding = "medium", disabled = false, active = false, onClick, ...props }, ref) => {
  let Comp2 = "button";
  props.isLink && (Comp2 = "a"), asChild && (Comp2 = $5e63c961fc1ce211$export$8c6ed5c666ac1360);
  let localVariant = variant, localSize = size, [isAnimating, setIsAnimating] = (0, import_react.useState)(false), handleClick = (event) => {
  ...
  if ((0, import_react.useEffect)(() => {
    ...
    let buttonContent = import_react.default.Children.toArray(props.children).filter((e) => typeof e == "string" && e !== "");
  ...
  return import_react.default.createElement(StyledButton, { as: Comp2, ref, variant: localVariant, size: localSize, padding, disabled, active, animating: isAnimating, animation, onClick: handleClick, ...props });
});
...
var IconButton = (0, import_react.forwardRef)(({ padding = "small", variant = "ghost", ...props }, ref) => import_react.default.createElement(Button, { padding, variant, ref, ...props }));
...
var Field = ({ label, children, ...props }) => import_react.default.createElement(Wrapper, { ...props }, label ? import_react.default.createElement(Label, null, import_react.default.createElement("span", null, label)) : null, children);
...
var TextareaAutosize = function(_ref, userRef) {
  ...
  return React3.useLayoutEffect(resizeTextarea), useWindowResizeListener(resizeTextarea), useFontsLoadedListener(resizeTextarea), React3.createElement("textarea", _extends({}, props, { onChange: handleChange, ref }));
};
...
var Input = Object.assign(newStyled((0, import_react.forwardRef)(function({ size, valid, align, ...props }, ref) {
  return import_react.default.createElement("input", { ...props, ref });
}))(styles, sizes, alignment, validation, { minHeight: 32 }), { displayName: "Input" });
var Select = Object.assign(newStyled((0, import_react.forwardRef)(function({ size, valid, align, ...props }, ref) {
  return import_react.default.createElement("select", { ...props, ref });
}))(styles, sizes, validation, { height: 32, userSelect: "none", paddingRight: 20, appearance: "menulist" }), { displayName: "Select" });
var Textarea = Object.assign(newStyled((0, import_react.forwardRef)(function({ size, valid, align, ...props }, ref) {
  return import_react.default.createElement(index2, { ...props, ref });
...
var LazyWithTooltip = (0, import_react.lazy)(() => import("./WithTooltip-Y7J54OF7-HYB3ZY5K.js").then((mod) => ({ default: mod.WithTooltip })));
var WithTooltip = (props) => import_react.default.createElement(import_react.Suspense, { fallback: import_react.default.createElement("div", null) }, import_react.default.createElement(LazyWithTooltip, { ...props }));
var LazyWithTooltipPure = (0, import_react.lazy)(() => import("./WithTooltip-Y7J54OF7-HYB3ZY5K.js").then((mod) => ({ default: mod.WithTooltipPure })));
var WithTooltipPure = (props) => import_react.default.createElement(import_react.Suspense, { fallback: import_react.default.createElement("div", null) }, import_react.default.createElement(LazyWithTooltipPure, { ...props }));
...
var TooltipMessage = ({ title, desc, links }) => import_react.default.createElement(MessageWrapper, null, import_react.default.createElement(Message2, null, title && import_react.default.createElement(Title2, null, title), desc && import_react.default.createElement(Desc2, null, desc)), links && import_react.default.createElement(Links, null, links.map(({ title: linkTitle, ...other }) => import_react.default.createElement(Link2, { ...other, key: linkTitle }, linkTitle))));
...
var TooltipNote = ({ note, ...props }) => import_react.default.createElement(Note, { ...props }, note);
var Title3 = newStyled(({ active, loading, disabled, ...rest }) => import_react.default.createElement("span", { ...rest }))(({ theme }) => ({ color: theme.color.defaultText, fontWeight: theme.typography.weight.regular }), ({ active, theme }) => active ? { color: theme.color.secondary, fontWeight: theme.typography.weight.bold } : {}, ({ loading, theme }) => loading ? { display: "inline-block", flex: "none", ...theme.animation.inlineGlow } : {}, ({ disabled, theme }) => disabled ? { color: curriedTransparentize$1(0.7, theme.color.defaultText) } : {});
...
var ListItem = ({ loading, title, center, right, icon, active, disabled, isIndented, href, onClick, LinkWrapper, ...rest }) => {
  let itemProps = getItemProps(onClick, href, LinkWrapper), commonProps = { active, disabled };
  return import_react.default.createElement(Item, { ...commonProps, ...rest, ...itemProps }, icon && import_react.default.createElement(Left, { ...commonProps }, icon), title || center ? import_react.default.createElement(Center, { isIndented: !icon && isIndented }, title && import_react.default.createElement(Title3, { ...commonProps, loading }, title), center && import_react.default.createElement(CenterText, { ...commonProps }, center)) : null, right && import_react.default.createElement(Right, { ...commonProps }, right));
};
ListItem.defaultProps = { loading: false, title: import_react.default.createElement("span", null, "Loading state"), center: null, right: null, active: false, disabled: false, href: null, LinkWrapper: null, onClick: null };
...
var Item2 = (props) => {
  let { LinkWrapper, onClick: onClickFromProps, id, isIndented, ...rest } = props, { title, href, active } = rest, onClick = (0, import_react.useCallback)((event) => {
    onClickFromProps(event, rest);
  }, [onClickFromProps]), hasOnClick = !!onClickFromProps;
  return import_react.default.createElement(ListItem_default, { title, active, href, id: `list-item-${id}`, LinkWrapper, isIndented, ...rest, ...hasOnClick ? { onClick } : {} });
};
var TooltipLinkList = ({ links, LinkWrapper }) => {
  let hasIcon = links.some((link) => link.icon);
  return import_react.default.createElement(List, null, links.map(({ isGatsby, ...p }) => import_react.default.createElement(Item2, { key: p.id, LinkWrapper: isGatsby ? LinkWrapper : null, isIndented: hasIcon, ...p })));
};
...
function ForwardRefFunction({ children, ...rest }, ref) {
  ...
  if (isLink(o))
    return import_react.default.createElement("a", { ref: o.ref, ...o.props }, children);
  if (isButton(o))
    return import_react.default.createElement("button", { ref: o.ref, type: "button", ...o.props }, children);
  throw new Error("invalid props");
}
var ButtonOrLink = (0, import_react.forwardRef)(ForwardRefFunction);
...
var IconButtonSkeleton = () => import_react.default.createElement(IconButtonSkeletonWrapper, null, import_react.default.createElement(IconPlaceholder, null));
...
var UnstyledBar = ({ children, className, scrollable }) => scrollable ? import_react.default.createElement(ScrollArea, { vertical: false, className }, children) : import_react.default.createElement("div", { className }, children);
...
var FlexBar = ({ children, backgroundColor, className, ...rest }) => {
  let [left, right] = import_react.Children.toArray(children);
  return import_react.default.createElement(Bar, { className: `sb-bar ${className}`, ...rest }, import_react.default.createElement(BarInner, { bgColor: backgroundColor }, import_react.default.createElement(Side, { scrollable: rest.scrollable, left: true }, left), right ? import_react.default.createElement(Side, { right: true }, right) : null));
};
FlexBar.displayName = "FlexBar";
var VisuallyHidden = newStyled.div(({ active }) => active ? { display: "block" } : { display: "none" });
var childrenToList = (children) => import_react.Children.toArray(children).map(({ props: { title, id, color: color2, children: childrenOfChild } }) => {
  let content = Array.isArray(childrenOfChild) ? childrenOfChild[0] : childrenOfChild;
  return { title, id, ...color2 ? { color: color2 } : {}, render: typeof content == "function" ? content : ({ active }) => import_react.default.createElement(VisuallyHidden, { active, role: "tabpanel" }, content) };
});
...
function useList(list) {
  let tabBarRef = (0, import_react.useRef)(), addonsRef = (0, import_react.useRef)(), tabRefs = (0, import_react.useRef)(/* @__PURE__ */ new Map()), { width: tabBarWidth = 1 } = useResizeObserver({ ref: tabBarRef }), [visibleList, setVisibleList] = (0, import_react.useState)(list), [invisibleList, setInvisibleList] = (0, import_react.useState)([]), previousList = (0, import_react.useRef)(list), AddonTab = (0, import_react.useCallback)(({ menuName, actions }) => {
    let isAddonsActive = invisibleList.some(({ active }) => active), [isTooltipVisible, setTooltipVisible] = (0, import_react.useState)(false);
    return import_react.default.createElement(import_react.default.Fragment, null, import_react.default.createElement(WithToolTipState, { interactive: true, visible: isTooltipVisible, onVisibleChange: setTooltipVisible, placement: "bottom", delayHide: 100, tooltip: import_react.default.createElement(TooltipLinkList, { links: invisibleList.map(({ title, id, color: color2, active }) => ({ id, title, color: color2, active, onClick: (e) => {
      e.preventDefault(), actions.onSelect(id);
    } })) }) }, import_react.default.createElement(AddonButton, { ref: addonsRef, active: isAddonsActive, preActive: isTooltipVisible, style: { visibility: invisibleList.length ? "visible" : "hidden" }, "aria-hidden": !invisibleList.length, className: "tabbutton", type: "button", role: "tab" }, menuName, import_react.default.createElement(CollapseIcon2, { className: "addon-collapsible-icon", isActive: isAddonsActive || isTooltipVisible }))), invisibleList.map(({ title, id, color: color2 }, index3) => {
      let indexId = `index-${index3}`;
      return import_react.default.createElement(TabButton, { id: `tabbutton-${O(id) ?? indexId}`, style: { visibility: "hidden" }, "aria-hidden": true, tabIndex: -1, ref: (ref) => {
        tabRefs.current.set(id, ref);
      }, className: "tabbutton", type: "button", key: id, textColor: color2, role: "tab" }, title);
    }));
  }, [invisibleList]), setTabLists = (0, import_react.useCallback)(() => {
  ...
  return (0, import_react.useLayoutEffect)(setTabLists, [setTabLists, tabBarWidth]), { tabRefs, addonsRef, tabBarRef, visibleList, invisibleList, AddonTab };
}
...
var Title4 = newStyled.div(({ theme }) => ({ fontWeight: theme.typography.weight.bold, fontSize: theme.typography.size.s2 - 1, textAlign: "center", color: theme.textColor }));
var Description = newStyled.div(({ theme }) => ({ fontWeight: theme.typography.weight.regular, fontSize: theme.typography.size.s2 - 1, textAlign: "center", color: theme.textMutedColor }));
var EmptyTabContent = ({ title, description, footer }) => import_react.default.createElement(Wrapper2, null, import_react.default.createElement(Content, null, import_react.default.createElement(Title4, null, title), description && import_react.default.createElement(Description, null, description)), footer);
...
var TabWrapper = ({ active, render, children }) => import_react.default.createElement(VisuallyHidden, { active }, render ? render() : children);
var Tabs = (0, import_react.memo)(({ children, selected, actions, absolute, bordered, tools, backgroundColor, id: htmlId, menuName, emptyState, showToolsWhenEmpty }) => {
  let idList = childrenToList(children).map((i) => i.id).join(","), list = (0, import_react.useMemo)(() => childrenToList(children).map((i, index3) => ({ ...i, active: selected ? i.id === selected : index3 === 0 })), [selected, idList]), { visibleList, tabBarRef, tabRefs, AddonTab } = useList(list), EmptyContent = emptyState ?? import_react.default.createElement(EmptyTabContent, { title: "Nothing found" });
  return !showToolsWhenEmpty && list.length === 0 ? EmptyContent : import_react.default.createElement(Wrapper3, { absolute, bordered, id: htmlId }, import_react.default.createElement(FlexBar, { scrollable: false, border: true, backgroundColor }, import_react.default.createElement(TabBar, { style: { whiteSpace: "normal" }, ref: tabBarRef, role: "tablist" }, visibleList.map(({ title, id, active, color: color2 }, index3) => {
    let indexId = `index-${index3}`;
    return import_react.default.createElement(TabButton, { id: `tabbutton-${O(id) ?? indexId}`, ref: (ref) => {
      tabRefs.current.set(id, ref);
    }, className: `tabbutton ${active ? "tabbutton-active" : ""}`, type: "button", key: id, active, textColor: color2, onClick: (e) => {
      e.preventDefault(), actions.onSelect(id);
    }, role: "tab" }, typeof title == "function" ? import_react.default.createElement("title", null) : title);
  }), import_react.default.createElement(AddonTab, { menuName, actions })), tools), import_react.default.createElement(Content2, { id: "panel-tab-content", bordered, absolute }, list.length ? list.map(({ id, active, render }) => import_react.default.createElement(render, { key: id, active }, null)) : EmptyContent));
});
Tabs.displayName = "Tabs";
Tabs.defaultProps = { id: null, children: null, tools: null, selected: null, absolute: false, bordered: false, menuName: "Tabs" };
var TabsState = class extends import_react.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    return import_react.default.createElement(Tabs, { bordered, absolute, selected, backgroundColor, menuName, actions: this.handlers }, children);
  }
};
...
var interleaveSeparators = (list) => list.reduce((acc, item, index3) => item ? import_react.default.createElement(import_react.Fragment, { key: item.id || item.key || `f-${index3}` }, acc, index3 > 0 ? import_react.default.createElement(Separator, { key: `s-${index3}` }) : null, item.render() || item) : acc, null);
...
var AddonPanel = ({ active, children }) => import_react.default.createElement("div", { hidden: !active }, useUpdate(active, children));
...
var Icons = ({ icon, useSymbol, __suppressDeprecationWarning = false, ...props }) => {
  ...
  return import_react.default.createElement(Icon, { ...props });
};
var Symbols = (0, import_react.memo)(function({ icons: keys = Object.keys(icons) }) {
  return import_react.default.createElement(Svg, { viewBox: "0 0 14 14", style: { position: "absolute", width: 0, height: 0 }, "data-chromatic": "ignore" }, keys.map((key) => import_react.default.createElement("symbol", { id: `icon--${key}`, key }, icons[key])));
});
...
var Loader = ({ progress, error, size, ...props }) => {
  if (error)
    return import_react.default.createElement(ProgressWrapper, { "aria-label": error.toString(), "aria-live": "polite", role: "status", ...props }, import_react.default.createElement(ErrorIcon, null), import_react.default.createElement(ProgressMessage, null, error.message));
  if (progress) {
    let { value, modules } = progress, { message } = progress;
    return modules && (message += ` ${modules.complete} / ${modules.total} modules`), import_react.default.createElement(ProgressWrapper, { "aria-label": "Content is loading...", "aria-live": "polite", "aria-valuemin": 0, "aria-valuemax": 100, "aria-valuenow": value * 100, "aria-valuetext": message, role: "progressbar", ...props }, import_react.default.createElement(ProgressTrack, null, import_react.default.createElement(ProgressBar, { style: { width: `${value * 100}%` } })), import_react.default.createElement(ProgressMessage, null, message, value < 1 && import_react.default.createElement(Ellipsis, { key: message })));
  }
  return import_react.default.createElement(LoaderWrapper, { "aria-label": "Content is loading...", "aria-live": "polite", role: "status", size, ...props });
};
...
`;
var ClipboardCode = ({ code, ...props }) => import_react.default.createElement(Code2, { id: "clipboard-code", ...props }, code);
...
//# sourceMappingURL=chunk-XA3ZWAJ4.js.map
