import {
  ...
  SyntaxHighlighter2,
  useComposedRefs
} from "./chunk-2UQGLG45.js";
import {
  WithToolTipState
} from "./chunk-RKI3LCVX.js";
import {
  _extends,
  ...
  newStyled,
  typography
} from "./chunk-SRYMRIRK.js";
import {
  __export as __export2
} from "./chunk-NCYI2GVL.js";
import {
  O
} from "./chunk-XKUS2X5V.js";
import {
  require_client_logger
} from "./chunk-26WBM6OG.js";
import {
  require_global
...
var Link = ({ href: input, ...props }) => {
  ...
  return import_react4.default.createElement("a", { href, target, ...props });
};
...
var Code = ({ className, children, ...props }) => {
  let language = (className || "").match(/lang-(\S+)/), childrenArray = import_react4.Children.toArray(children);
  return childrenArray.filter(isReactChildString).some((child) => child.match(isInlineCodeRegex)) ? import_react4.default.createElement(StyledSyntaxHighlighter, { bordered: true, copyable: true, language: (language == null ? void 0 : language[1]) ?? "text", format: false, ...props }, children) : import_react4.default.createElement(DefaultCodeBlock, { ...props, className }, childrenArray);
};
...
var components = { h1: (props) => import_react4.default.createElement(H1, { ...nameSpaceClassNames(props, "h1") }), h2: (props) => import_react4.default.createElement(H2, { ...nameSpaceClassNames(props, "h2") }), h3: (props) => import_react4.default.createElement(H3, { ...nameSpaceClassNames(props, "h3") }), h4: (props) => import_react4.default.createElement(H4, { ...nameSpaceClassNames(props, "h4") }), h5: (props) => import_react4.default.createElement(H5, { ...nameSpaceClassNames(props, "h5") }), h6: (props) => import_react4.default.createElement(H6, { ...nameSpaceClassNames(props, "h6") }), pre: (props) => import_react4.default.createElement(Pre, { ...nameSpaceClassNames(props, "pre") }), a: (props) => import_react4.default.createElement(A, { ...nameSpaceClassNames(props, "a") }), hr: (props) => import_react4.default.createElement(HR, { ...nameSpaceClassNames(props, "hr") }), dl: (props) => import_react4.default.createElement(DL, { ...nameSpaceClassNames(props, "dl") }), blockquote: (props) => import_react4.default.createElement(Blockquote, { ...nameSpaceClassNames(props, "blockquote") }), table: (props) => import_react4.default.createElement(Table, { ...nameSpaceClassNames(props, "table") }), img: (props) => import_react4.default.createElement(Img, { ...nameSpaceClassNames(props, "img") }), div: (props) => import_react4.default.createElement(Div, { ...nameSpaceClassNames(props, "div") }), span: (props) => import_react4.default.createElement(Span, { ...nameSpaceClassNames(props, "span") }), li: (props) => import_react4.default.createElement(LI, { ...nameSpaceClassNames(props, "li") }), ul: (props) => import_react4.default.createElement(UL, { ...nameSpaceClassNames(props, "ul") }), ol: (props) => import_react4.default.createElement(OL, { ...nameSpaceClassNames(props, "ol") }), p: (props) => import_react4.default.createElement(P, { ...nameSpaceClassNames(props, "p") }), code: (props) => import_react4.default.createElement(Code, { ...nameSpaceClassNames(props, "code") }), tt: (props) => import_react4.default.createElement(TT, { ...nameSpaceClassNames(props, "tt") }), resetwrapper: (props) => import_react4.default.createElement(ResetWrapper, { ...nameSpaceClassNames(props, "resetwrapper") }) };
...
var Badge = ({ ...props }) => import_react4.default.createElement(BadgeWrapper, { ...props });
var LEFT_BUTTON = 0;
...
var Link2 = ({ cancel = true, children, onClick = void 0, withArrow = false, containsIcon = false, className = void 0, style = void 0, ...rest }) => import_react4.default.createElement(A2, { ...rest, onClick: onClick && cancel ? (e) => cancelled(e, onClick) : onClick, className }, import_react4.default.createElement(LinkInner, { withArrow, containsIcon }, children, withArrow && import_react4.default.createElement(ChevronRightIcon, null)));
...
var languages = [];
var Comp = null;
var LazySyntaxHighlighter = (0, import_react4.lazy)(async () => {
  let { SyntaxHighlighter: SyntaxHighlighter3 } = await import("./syntaxhighlighter-BP7B2CQK-LKXD5U53.js");
  return languages.length > 0 && (languages.forEach((args) => {
    SyntaxHighlighter3.registerLanguage(...args);
  }), languages = []), Comp === null && (Comp = SyntaxHighlighter3), { default: (props) => import_react4.default.createElement(SyntaxHighlighter3, { ...props }) };
});
var LazySyntaxHighlighterWithFormatter = (0, import_react4.lazy)(async () => {
  let [{ SyntaxHighlighter: SyntaxHighlighter3 }, { formatter }] = await Promise.all([import("./syntaxhighlighter-BP7B2CQK-LKXD5U53.js"), import("./formatter-2WMMO6ZP-VAPU5YJK.js")]);
  return languages.length > 0 && (languages.forEach((args) => {
    SyntaxHighlighter3.registerLanguage(...args);
  }), languages = []), Comp === null && (Comp = SyntaxHighlighter3), { default: (props) => import_react4.default.createElement(SyntaxHighlighter3, { ...props, formatter }) };
});
var SyntaxHighlighter22 = (props) => import_react4.default.createElement(import_react4.Suspense, { fallback: import_react4.default.createElement("div", null) }, props.format !== false ? import_react4.default.createElement(LazySyntaxHighlighterWithFormatter, { ...props }) : import_react4.default.createElement(LazySyntaxHighlighter, { ...props }));
...
__export2(Modal_styled_exports, { Actions: () => Actions, CloseButton: () => CloseButton, Col: () => Col, Container: () => Container, Content: () => Content2, Description: () => Description2, Error: () => Error2, ErrorWrapper: () => ErrorWrapper, Header: () => Header, Overlay: () => Overlay2, Row: () => Row, Title: () => Title2 });
var Button = (0, import_react4.forwardRef)(({ asChild = false, animation = "none", size = "small", variant = "outline", padding = "medium", disabled = false, active = false, onClick, ...props }, ref) => {
  let Comp2 = "button";
  props.isLink && (Comp2 = "a"), asChild && (Comp2 = Slot);
  let localVariant = variant, localSize = size, [isAnimating, setIsAnimating] = (0, import_react4.useState)(false), handleClick = (event) => {
  ...
  if ((0, import_react4.useEffect)(() => {
    ...
    let buttonContent = import_react4.default.Children.toArray(props.children).filter((e) => typeof e == "string" && e !== "");
  ...
  return import_react4.default.createElement(StyledButton, { as: Comp2, ref, variant: localVariant, size: localSize, padding, disabled, active, animating: isAnimating, animation, onClick: handleClick, ...props });
});
...
var IconButton = (0, import_react4.forwardRef)(({ padding = "small", variant = "ghost", ...props }, ref) => import_react4.default.createElement(Button, { padding, variant, ref, ...props }));
...
var Overlay2 = newStyled.div({ backgroundColor: "rgba(27, 28, 29, 0.2)", position: "fixed", inset: 0, width: "100%", height: "100%", zIndex: 10, animation: `${fadeIn} 200ms` });
...
var CloseButton = (props) => import_react4.default.createElement(Close, { asChild: true }, import_react4.default.createElement(IconButton, { ...props }, import_react4.default.createElement(CrossIcon, null)));
var Content2 = newStyled.div({ display: "flex", flexDirection: "column", margin: 16, gap: 16 });
...
var Header = (props) => import_react4.default.createElement(Row, null, import_react4.default.createElement(Col, { ...props }), import_react4.default.createElement(CloseButton, null));
var Title2 = newStyled(Title)(({ theme }) => ({ margin: 0, fontSize: theme.typography.size.s3, fontWeight: theme.typography.weight.bold }));
var Description2 = newStyled(Description)(({ theme }) => ({ position: "relative", zIndex: 1, margin: 0, fontSize: theme.typography.size.s2 }));
...
var Error2 = ({ children, ...props }) => import_react4.default.createElement(ErrorWrapper, { ...props }, import_react4.default.createElement("div", null, children));
function BaseModal({ children, width, height, onEscapeKeyDown, onInteractOutside = (ev) => ev.preventDefault(), className, container, ...rootProps }) {
  return import_react4.default.createElement(Root, { ...rootProps }, import_react4.default.createElement(Portal2, { container }, import_react4.default.createElement(Overlay, { asChild: true }, import_react4.default.createElement(Overlay2, null)), import_react4.default.createElement(Content, { asChild: true, onInteractOutside, onEscapeKeyDown }, import_react4.default.createElement(Container, { className, width, height }, children))));
}
...
var Spaced = ({ col, row, outer, children, ...rest }) => {
  ...
  return import_react4.default.createElement(Container2, { col, row, outer: outerAmount, ...rest }, children);
};
...
var Placeholder = ({ children, ...props }) => {
  let [title, desc] = import_react4.Children.toArray(children);
  return import_react4.default.createElement(Message, { ...props }, import_react4.default.createElement(Title3, null, title), desc && import_react4.default.createElement(Desc, null, desc));
};
function useResolvedElement(subscriber, refOrElement) {
  var lastReportRef = (0, import_react4.useRef)(null), refOrElementRef = (0, import_react4.useRef)(null);
  refOrElementRef.current = refOrElement;
  var cbElementRef = (0, import_react4.useRef)(null);
  (0, import_react4.useEffect)(function() {
    evaluateSubscription();
  });
  var evaluateSubscription = (0, import_react4.useCallback)(function() {
  ...
  }, []), (0, import_react4.useCallback)(function(element) {
...
function useResizeObserver(opts) {
  opts === void 0 && (opts = {});
  var onResize = opts.onResize, onResizeRef = (0, import_react4.useRef)(void 0);
  onResizeRef.current = onResize;
  var round = opts.round || Math.round, resizeObserverRef = (0, import_react4.useRef)(), _useState = (0, import_react4.useState)({ width: void 0, height: void 0 }), size = _useState[0], setSize = _useState[1], didUnmount = (0, import_react4.useRef)(false);
  (0, import_react4.useEffect)(function() {
    return didUnmount.current = false, function() {
      didUnmount.current = true;
    };
  }, []);
  var previous = (0, import_react4.useRef)({ width: void 0, height: void 0 }), refCallback = useResolvedElement((0, import_react4.useCallback)(function(element) {
...
function ZoomElement({ scale, children }) {
  let componentWrapperRef = (0, import_react4.useRef)(null), [elementHeight, setElementHeight] = (0, import_react4.useState)(0), onResize = (0, import_react4.useCallback)(({ height }) => {
  ...
  }, [scale]), useResizeObserver({ ref: componentWrapperRef, onResize }), import_react4.default.createElement(ZoomElementWrapper, { scale, elementHeight }, import_react4.default.createElement("div", { ref: componentWrapperRef, className: "innerZoomElementWrapper" }, children));
}
var ZoomIFrame = class extends import_react4.Component {
  constructor() {
    super(...arguments);
    this.iframe = null;
  }
...
var ErrorFormatter = ({ error }) => {
  if (!error) return import_react4.default.createElement(import_react4.Fragment, null, "This error has no stack or message");
  if (!error.stack) return import_react4.default.createElement(import_react4.Fragment, null, error.message || "This error has no stack or message");
...
${input}`);
  ...
  if (!match) return import_react4.default.createElement(import_react4.Fragment, null, input);
  ...
  return import_react4.default.createElement(import_react4.Fragment, null, import_react4.default.createElement("span", null, type), ": ", import_react4.default.createElement(ErrorName, null, name), import_react4.default.createElement("br", null), lines.map((l, i) => l.name ? import_react4.default.createElement(import_react4.Fragment, { key: i }, "  ", "at ", import_react4.default.createElement(ErrorImportant, null, l.name), " (", import_react4.default.createElement(ErrorDetail, null, l.location), ")", import_react4.default.createElement("br", null)) : import_react4.default.createElement(import_react4.Fragment, { key: i }, "  ", "at ", import_react4.default.createElement(ErrorDetail, null, l.location), import_react4.default.createElement("br", null))));
};
...
var Field = ({ label, children, ...props }) => import_react4.default.createElement(Wrapper, { ...props }, label ? import_react4.default.createElement(Label, null, import_react4.default.createElement("span", null, label)) : null, children);
...
var useComposedRef = function(libRef, userRef) {
  var prevUserRef = (0, import_react4.useRef)();
  return (0, import_react4.useCallback)(function(instance) {
...
var Input = Object.assign(newStyled((0, import_react4.forwardRef)(function({ size, valid, align, ...props }, ref) {
  return import_react4.default.createElement("input", { ...props, ref });
}))(styles, sizes, alignment, validation, { minHeight: 32 }), { displayName: "Input" });
var Select = Object.assign(newStyled((0, import_react4.forwardRef)(function({ size, valid, align, ...props }, ref) {
  return import_react4.default.createElement("select", { ...props, ref });
}))(styles, sizes, validation, { height: 32, userSelect: "none", paddingRight: 20, appearance: "menulist" }), { displayName: "Select" });
var Textarea = Object.assign(newStyled((0, import_react4.forwardRef)(function({ size, valid, align, ...props }, ref) {
  return import_react4.default.createElement(index2, { ...props, ref });
...
var LazyWithTooltip = (0, import_react4.lazy)(() => import("./WithTooltip-KJL26V4Q-57XNTYTG.js").then((mod) => ({ default: mod.WithTooltip })));
var WithTooltip = (props) => import_react4.default.createElement(import_react4.Suspense, { fallback: import_react4.default.createElement("div", null) }, import_react4.default.createElement(LazyWithTooltip, { ...props }));
var LazyWithTooltipPure = (0, import_react4.lazy)(() => import("./WithTooltip-KJL26V4Q-57XNTYTG.js").then((mod) => ({ default: mod.WithTooltipPure })));
var WithTooltipPure = (props) => import_react4.default.createElement(import_react4.Suspense, { fallback: import_react4.default.createElement("div", null) }, import_react4.default.createElement(LazyWithTooltipPure, { ...props }));
...
var TooltipMessage = ({ title, desc, links }) => import_react4.default.createElement(MessageWrapper, null, import_react4.default.createElement(Message2, null, title && import_react4.default.createElement(Title4, null, title), desc && import_react4.default.createElement(Desc2, null, desc)), links && import_react4.default.createElement(Links, null, links.map(({ title: linkTitle, ...other }) => import_react4.default.createElement(Link2, { ...other, key: linkTitle }, linkTitle))));
...
var TooltipNote = ({ note, ...props }) => import_react4.default.createElement(Note, { ...props }, note);
var Title5 = newStyled(({ active, loading, disabled, ...rest }) => import_react4.default.createElement("span", { ...rest }))(({ theme }) => ({ color: theme.color.defaultText, fontWeight: theme.typography.weight.regular }), ({ active, theme }) => active ? { color: theme.color.secondary, fontWeight: theme.typography.weight.bold } : {}, ({ loading, theme }) => loading ? { display: "inline-block", flex: "none", ...theme.animation.inlineGlow } : {}, ({ disabled, theme }) => disabled ? { color: curriedTransparentize$1(0.7, theme.color.defaultText) } : {});
...
var ListItem = ({ loading = false, title = import_react4.default.createElement("span", null, "Loading state"), center = null, right = null, active = false, disabled = false, isIndented, href = null, onClick = null, icon, LinkWrapper = null, ...rest }) => {
  let itemProps = getItemProps(onClick, href, LinkWrapper), commonProps = { active, disabled };
  return import_react4.default.createElement(Item, { ...commonProps, ...rest, ...itemProps }, icon && import_react4.default.createElement(Left, { ...commonProps }, icon), title || center ? import_react4.default.createElement(Center, { isIndented: !icon && isIndented }, title && import_react4.default.createElement(Title5, { ...commonProps, loading }, title), center && import_react4.default.createElement(CenterText, { ...commonProps }, center)) : null, right && import_react4.default.createElement(Right, { ...commonProps }, right));
};
...
var Item2 = (props) => {
  let { LinkWrapper, onClick: onClickFromProps, id, isIndented, ...rest } = props, { title, href, active } = rest, onClick = (0, import_react4.useCallback)((event) => {
    onClickFromProps(event, rest);
  }, [onClickFromProps]), hasOnClick = !!onClickFromProps;
  return import_react4.default.createElement(ListItem_default, { title, active, href, id: `list-item-${id}`, LinkWrapper, isIndented, ...rest, ...hasOnClick ? { onClick } : {} });
};
var TooltipLinkList = ({ links, LinkWrapper = null }) => {
  let hasIcon = links.some((link) => link.icon);
  return import_react4.default.createElement(List, null, links.map(({ isGatsby, ...p }) => import_react4.default.createElement(Item2, { key: p.id, LinkWrapper: isGatsby ? LinkWrapper : null, isIndented: hasIcon, ...p })));
};
...
function ForwardRefFunction({ children, ...rest }, ref) {
  ...
  if (isLink(o)) return import_react4.default.createElement("a", { ref: o.ref, ...o.props }, children);
  if (isButton(o)) return import_react4.default.createElement("button", { ref: o.ref, type: "button", ...o.props }, children);
  throw new Error("invalid props");
}
var ButtonOrLink = (0, import_react4.forwardRef)(ForwardRefFunction);
...
var IconButtonSkeleton = () => import_react4.default.createElement(IconButtonSkeletonWrapper, null, import_react4.default.createElement(IconPlaceholder, null));
...
var UnstyledBar = ({ children, className, scrollable }) => scrollable ? import_react4.default.createElement(ScrollArea, { vertical: false, className }, children) : import_react4.default.createElement("div", { className }, children);
...
var FlexBar = ({ children, backgroundColor, className, ...rest }) => {
  let [left, right] = import_react4.Children.toArray(children);
  return import_react4.default.createElement(Bar, { className: `sb-bar ${className}`, ...rest }, import_react4.default.createElement(BarInner, { bgColor: backgroundColor }, import_react4.default.createElement(Side, { scrollable: rest.scrollable, left: true }, left), right ? import_react4.default.createElement(Side, { right: true }, right) : null));
};
FlexBar.displayName = "FlexBar";
var VisuallyHidden = newStyled.div(({ active }) => active ? { display: "block" } : { display: "none" });
var childrenToList = (children) => import_react4.Children.toArray(children).map(({ props: { title, id, color: color2, children: childrenOfChild } }) => {
  let content = Array.isArray(childrenOfChild) ? childrenOfChild[0] : childrenOfChild;
  return { title, id, ...color2 ? { color: color2 } : {}, render: typeof content == "function" ? content : ({ active }) => import_react4.default.createElement(VisuallyHidden, { active, role: "tabpanel" }, content) };
});
...
function useList(list) {
  let tabBarRef = (0, import_react4.useRef)(), addonsRef = (0, import_react4.useRef)(), tabRefs = (0, import_react4.useRef)(/* @__PURE__ */ new Map()), { width: tabBarWidth = 1 } = useResizeObserver({ ref: tabBarRef }), [visibleList, setVisibleList] = (0, import_react4.useState)(list), [invisibleList, setInvisibleList] = (0, import_react4.useState)([]), previousList = (0, import_react4.useRef)(list), AddonTab = (0, import_react4.useCallback)(({ menuName, actions }) => {
    let isAddonsActive = invisibleList.some(({ active }) => active), [isTooltipVisible, setTooltipVisible] = (0, import_react4.useState)(false);
    return import_react4.default.createElement(import_react4.default.Fragment, null, import_react4.default.createElement(WithToolTipState, { interactive: true, visible: isTooltipVisible, onVisibleChange: setTooltipVisible, placement: "bottom", delayHide: 100, tooltip: import_react4.default.createElement(TooltipLinkList, { links: invisibleList.map(({ title, id, color: color2, active }) => ({ id, title, color: color2, active, onClick: (e) => {
      e.preventDefault(), actions.onSelect(id);
    } })) }) }, import_react4.default.createElement(AddonButton, { ref: addonsRef, active: isAddonsActive, preActive: isTooltipVisible, style: { visibility: invisibleList.length ? "visible" : "hidden" }, "aria-hidden": !invisibleList.length, className: "tabbutton", type: "button", role: "tab" }, menuName, import_react4.default.createElement(CollapseIcon2, { className: "addon-collapsible-icon", isActive: isAddonsActive || isTooltipVisible }))), invisibleList.map(({ title, id, color: color2 }, index3) => {
      let indexId = `index-${index3}`;
      return import_react4.default.createElement(TabButton, { id: `tabbutton-${O(id) ?? indexId}`, style: { visibility: "hidden" }, "aria-hidden": true, tabIndex: -1, ref: (ref) => {
        tabRefs.current.set(id, ref);
      }, className: "tabbutton", type: "button", key: id, textColor: color2, role: "tab" }, title);
    }));
  }, [invisibleList]), setTabLists = (0, import_react4.useCallback)(() => {
  ...
  return (0, import_react4.useLayoutEffect)(setTabLists, [setTabLists, tabBarWidth]), { tabRefs, addonsRef, tabBarRef, visibleList, invisibleList, AddonTab };
}
...
var EmptyTabContent = ({ title, description, footer }) => import_react4.default.createElement(Wrapper2, null, import_react4.default.createElement(Content3, null, import_react4.default.createElement(Title6, null, title), description && import_react4.default.createElement(Description3, null, description)), footer);
...
var TabWrapper = ({ active, render, children }) => import_react4.default.createElement(VisuallyHidden, { active }, render ? render() : children);
var Tabs = (0, import_react4.memo)(({ children, selected = null, actions, absolute = false, bordered = false, tools = null, backgroundColor, id: htmlId = null, menuName = "Tabs", emptyState, showToolsWhenEmpty }) => {
  let list = (0, import_react4.useMemo)(() => childrenToList(children).map((i, index3) => ({ ...i, active: selected ? i.id === selected : index3 === 0 })), [children, selected]), { visibleList, tabBarRef, tabRefs, AddonTab } = useList(list), EmptyContent = emptyState ?? import_react4.default.createElement(EmptyTabContent, { title: "Nothing found" });
  return !showToolsWhenEmpty && list.length === 0 ? EmptyContent : import_react4.default.createElement(Wrapper3, { absolute, bordered, id: htmlId }, import_react4.default.createElement(FlexBar, { scrollable: false, border: true, backgroundColor }, import_react4.default.createElement(TabBar, { style: { whiteSpace: "normal" }, ref: tabBarRef, role: "tablist" }, visibleList.map(({ title, id, active, color: color2 }, index3) => {
    let indexId = `index-${index3}`;
    return import_react4.default.createElement(TabButton, { id: `tabbutton-${O(id) ?? indexId}`, ref: (ref) => {
      tabRefs.current.set(id, ref);
    }, className: `tabbutton ${active ? "tabbutton-active" : ""}`, type: "button", key: id, active, textColor: color2, onClick: (e) => {
      e.preventDefault(), actions.onSelect(id);
    }, role: "tab" }, typeof title == "function" ? import_react4.default.createElement("title", null) : title);
  }), import_react4.default.createElement(AddonTab, { menuName, actions })), tools), import_react4.default.createElement(Content4, { id: "panel-tab-content", bordered, absolute }, list.length ? list.map(({ id, active, render }) => import_react4.default.createElement(render, { key: id, active }, null)) : EmptyContent));
});
Tabs.displayName = "Tabs";
var TabsState = class extends import_react4.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    return import_react4.default.createElement(Tabs, { bordered, absolute, selected, backgroundColor, menuName, actions: this.handlers }, children);
  }
};
...
var interleaveSeparators = (list) => list.reduce((acc, item, index3) => item ? import_react4.default.createElement(import_react4.Fragment, { key: item.id || item.key || `f-${index3}` }, acc, index3 > 0 ? import_react4.default.createElement(Separator, { key: `s-${index3}` }) : null, item.render() || item) : acc, null);
...
var AddonPanel = ({ active, children }) => import_react4.default.createElement("div", { hidden: !active }, useUpdate(active, children));
...
var Icons = ({ icon, useSymbol, __suppressDeprecationWarning = false, ...props }) => {
  ...
  return import_react4.default.createElement(Icon, { ...props });
};
var Symbols = (0, import_react4.memo)(function({ icons: keys = Object.keys(icons) }) {
  return import_react4.default.createElement(Svg, { viewBox: "0 0 14 14", style: { position: "absolute", width: 0, height: 0 }, "data-chromatic": "ignore" }, keys.map((key) => import_react4.default.createElement("symbol", { id: `icon--${key}`, key }, icons[key])));
});
...
var StorybookLogo = ({ alt, ...props }) => import_react4.default.createElement("svg", { width: "200px", height: "40px", viewBox: "0 0 200 40", ...props, role: "img" }, alt ? import_react4.default.createElement("title", null, alt) : null, import_react4.default.createElement("defs", null, import_react4.default.createElement("path", { d: "M1.2 36.9L0 3.9c0-1.1.8-2 1.9-2.1l28-1.8a2 2 0 0 1 2.2 1.9 2 2 0 0 1 0 .1v36a2 2 0 0 1-2 2 2 2 0 0 1-.1 0L3.2 38.8a2 2 0 0 1-2-2z", id: "a" })), import_react4.default.createElement("g", { fill: "none", fillRule: "evenodd" }, import_react4.default.createElement("path", { d: "M53.3 31.7c-1.7 0-3.4-.3-5-.7-1.5-.5-2.8-1.1-3.9-2l1.6-3.5c2.2 1.5 4.6 2.3 7.3 2.3 1.5 0 2.5-.2 3.3-.7.7-.5 1.1-1 1.1-1.9 0-.7-.3-1.3-1-1.7s-2-.8-3.7-1.2c-2-.4-3.6-.9-4.8-1.5-1.1-.5-2-1.2-2.6-2-.5-1-.8-2-.8-3.2 0-1.4.4-2.6 1.2-3.6.7-1.1 1.8-2 3.2-2.6 1.3-.6 2.9-.9 4.7-.9 1.6 0 3.1.3 4.6.7 1.5.5 2.7 1.1 3.5 2l-1.6 3.5c-2-1.5-4.2-2.3-6.5-2.3-1.3 0-2.3.2-3 .8-.8.5-1.2 1.1-1.2 2 0 .5.2 1 .5 1.3.2.3.7.6 1.4.9l2.9.8c2.9.6 5 1.4 6.2 2.4a5 5 0 0 1 2 4.2 6 6 0 0 1-2.5 5c-1.7 1.2-4 1.9-7 1.9zm21-3.6l1.4-.1-.2 3.5-1.9.1c-2.4 0-4.1-.5-5.2-1.5-1.1-1-1.6-2.7-1.6-4.8v-6h-3v-3.6h3V11h4.8v4.6h4v3.6h-4v6c0 1.8.9 2.8 2.6 2.8zm11.1 3.5c-1.6 0-3-.3-4.3-1a7 7 0 0 1-3-2.8c-.6-1.3-1-2.7-1-4.4 0-1.6.4-3 1-4.3a7 7 0 0 1 3-2.8c1.2-.7 2.7-1 4.3-1 1.7 0 3.2.3 4.4 1a7 7 0 0 1 3 2.8c.6 1.2 1 2.7 1 4.3 0 1.7-.4 3.1-1 4.4a7 7 0 0 1-3 2.8c-1.2.7-2.7 1-4.4 1zm0-3.6c2.4 0 3.6-1.6 3.6-4.6 0-1.5-.3-2.6-1-3.4a3.2 3.2 0 0 0-2.6-1c-2.3 0-3.5 1.4-3.5 4.4 0 3 1.2 4.6 3.5 4.6zm21.7-8.8l-2.7.3c-1.3.2-2.3.5-2.8 1.2-.6.6-.9 1.4-.9 2.5v8.2H96V15.7h4.6v2.6c.8-1.8 2.5-2.8 5-3h1.3l.3 4zm14-3.5h4.8L116.4 37h-4.9l3-6.6-6.4-14.8h5l4 10 4-10zm16-.4c1.4 0 2.6.3 3.6 1 1 .6 1.9 1.6 2.5 2.8.6 1.2.9 2.7.9 4.3 0 1.6-.3 3-1 4.3a6.9 6.9 0 0 1-2.4 2.9c-1 .7-2.2 1-3.6 1-1 0-2-.2-3-.7-.8-.4-1.5-1-2-1.9v2.4h-4.7V8.8h4.8v9c.5-.8 1.2-1.4 2-1.9.9-.4 1.8-.6 3-.6zM135.7 28c1.1 0 2-.4 2.6-1.2.6-.8 1-2 1-3.4 0-1.5-.4-2.5-1-3.3s-1.5-1.1-2.6-1.1-2 .3-2.6 1.1c-.6.8-1 2-1 3.3 0 1.5.4 2.6 1 3.4.6.8 1.5 1.2 2.6 1.2zm18.9 3.6c-1.7 0-3.2-.3-4.4-1a7 7 0 0 1-3-2.8c-.6-1.3-1-2.7-1-4.4 0-1.6.4-3 1-4.3a7 7 0 0 1 3-2.8c1.2-.7 2.7-1 4.4-1 1.6 0 3 .3 4.3 1a7 7 0 0 1 3 2.8c.6 1.2 1 2.7 1 4.3 0 1.7-.4 3.1-1 4.4a7 7 0 0 1-3 2.8c-1.2.7-2.7 1-4.3 1zm0-3.6c2.3 0 3.5-1.6 3.5-4.6 0-1.5-.3-2.6-1-3.4a3.2 3.2 0 0 0-2.5-1c-2.4 0-3.6 1.4-3.6 4.4 0 3 1.2 4.6 3.6 4.6zm18 3.6c-1.7 0-3.2-.3-4.4-1a7 7 0 0 1-3-2.8c-.6-1.3-1-2.7-1-4.4 0-1.6.4-3 1-4.3a7 7 0 0 1 3-2.8c1.2-.7 2.7-1 4.4-1 1.6 0 3 .3 4.4 1a7 7 0 0 1 2.9 2.8c.6 1.2 1 2.7 1 4.3 0 1.7-.4 3.1-1 4.4a7 7 0 0 1-3 2.8c-1.2.7-2.7 1-4.3 1zm0-3.6c2.3 0 3.5-1.6 3.5-4.6 0-1.5-.3-2.6-1-3.4a3.2 3.2 0 0 0-2.5-1c-2.4 0-3.6 1.4-3.6 4.4 0 3 1.2 4.6 3.6 4.6zm27.4 3.4h-6l-6-7v7h-4.8V8.8h4.9v13.6l5.8-6.7h5.7l-6.6 7.5 7 8.2z", fill: "currentColor" }), import_react4.default.createElement("mask", { id: "b", fill: "#fff" }, import_react4.default.createElement("use", { xlinkHref: "#a" })), import_react4.default.createElement("use", { fill: "#FF4785", fillRule: "nonzero", xlinkHref: "#a" }), import_react4.default.createElement("path", { d: "M23.7 5L24 .2l3.9-.3.1 4.8a.3.3 0 0 1-.5.2L26 3.8l-1.7 1.4a.3.3 0 0 1-.5-.3zm-5 10c0 .9 5.3.5 6 0 0-5.4-2.8-8.2-8-8.2-5.3 0-8.2 2.8-8.2 7.1 0 7.4 10 7.6 10 11.6 0 1.2-.5 1.9-1.8 1.9-1.6 0-2.2-.9-2.1-3.6 0-.6-6.1-.8-6.3 0-.5 6.7 3.7 8.6 8.5 8.6 4.6 0 8.3-2.5 8.3-7 0-7.9-10.2-7.7-10.2-11.6 0-1.6 1.2-1.8 2-1.8.6 0 2 0 1.9 3z", fill: "#FFF", fillRule: "nonzero", mask: "url(#b)" })));
var StorybookIcon2 = (props) => import_react4.default.createElement("svg", { viewBox: "0 0 64 64", ...props }, import_react4.default.createElement("title", null, "Storybook icon"), import_react4.default.createElement("g", { id: "Artboard", stroke: "none", strokeWidth: "1", fill: "none", fillRule: "evenodd" }, import_react4.default.createElement("path", { d: "M8.04798541,58.7875918 L6.07908839,6.32540407 C6.01406344,4.5927838 7.34257463,3.12440831 9.07303814,3.01625434 L53.6958037,0.227331489 C55.457209,0.117243658 56.974354,1.45590096 57.0844418,3.21730626 C57.0885895,3.28366922 57.0906648,3.35014546 57.0906648,3.41663791 L57.0906648,60.5834697 C57.0906648,62.3483119 55.6599776,63.7789992 53.8951354,63.7789992 C53.847325,63.7789992 53.7995207,63.7779262 53.7517585,63.775781 L11.0978899,61.8600599 C9.43669044,61.7854501 8.11034889,60.4492961 8.04798541,58.7875918 Z", id: "path-1", fill: "#FF4785", fillRule: "nonzero" }), import_react4.default.createElement("path", { d: "M35.9095005,24.1768792 C35.9095005,25.420127 44.2838488,24.8242707 45.4080313,23.9509748 C45.4080313,15.4847538 40.8652557,11.0358878 32.5466666,11.0358878 C24.2280775,11.0358878 19.5673077,15.553972 19.5673077,22.3311017 C19.5673077,34.1346028 35.4965208,34.3605071 35.4965208,40.7987804 C35.4965208,42.606015 34.6115646,43.6790606 32.6646607,43.6790606 C30.127786,43.6790606 29.1248356,42.3834613 29.2428298,37.9783269 C29.2428298,37.0226907 19.5673077,36.7247626 19.2723223,37.9783269 C18.5211693,48.6535354 25.1720308,51.7326752 32.7826549,51.7326752 C40.1572906,51.7326752 45.939005,47.8018145 45.939005,40.6858282 C45.939005,28.035186 29.7738035,28.3740425 29.7738035,22.1051974 C29.7738035,19.5637737 31.6617103,19.2249173 32.7826549,19.2249173 C33.9625966,19.2249173 36.0864917,19.4328883 35.9095005,24.1768792 Z", id: "path9_fill-path", fill: "#FFFFFF", fillRule: "nonzero" }), import_react4.default.createElement("path", { d: "M44.0461638,0.830433986 L50.1874092,0.446606143 L50.443532,7.7810017 C50.4527198,8.04410717 50.2468789,8.26484453 49.9837734,8.27403237 C49.871115,8.27796649 49.7607078,8.24184808 49.6721567,8.17209069 L47.3089847,6.3104681 L44.5110468,8.43287463 C44.3012992,8.591981 44.0022839,8.55092814 43.8431776,8.34118051 C43.7762017,8.25288717 43.742082,8.14401677 43.7466857,8.03329059 L44.0461638,0.830433986 Z", id: "Path", fill: "#FFFFFF" })));
...
var Loader = ({ progress, error, size, ...props }) => {
  if (error) return import_react4.default.createElement(ProgressWrapper, { "aria-label": error.toString(), "aria-live": "polite", role: "status", ...props }, import_react4.default.createElement(ErrorIcon, null), import_react4.default.createElement(ProgressMessage, null, error.message));
  if (progress) {
    let { value, modules } = progress, { message } = progress;
    return modules && (message += ` ${modules.complete} / ${modules.total} modules`), import_react4.default.createElement(ProgressWrapper, { "aria-label": "Content is loading...", "aria-live": "polite", "aria-valuemin": 0, "aria-valuemax": 100, "aria-valuenow": value * 100, "aria-valuetext": message, role: "progressbar", ...props }, import_react4.default.createElement(ProgressTrack, null, import_react4.default.createElement(ProgressBar, { style: { width: `${value * 100}%` } })), import_react4.default.createElement(ProgressMessage, null, message, value < 1 && import_react4.default.createElement(Ellipsis, { key: message })));
  }
  return import_react4.default.createElement(LoaderWrapper, { "aria-label": "Content is loading...", "aria-live": "polite", role: "status", size, ...props });
};
...
`;
var ClipboardCode = ({ code, ...props }) => import_react4.default.createElement(Code2, { id: "clipboard-code", ...props }, code);
var components2 = components;
var resetComponents = {};
Object.keys(components).forEach((key) => {
  resetComponents[key] = (0, import_react4.forwardRef)((props, ref) => (0, import_react4.createElement)(key, { ...props, ref }));
});
...
//# sourceMappingURL=chunk-IOLHXOAW.js.map
