import {
  instrument
} from "./chunk-I3INYEYA.js";
import "./chunk-PVW3Y7IF.js";
import {
  require_client_logger
} from "./chunk-26WBM6OG.js";
import "./chunk-DXIOBCSA.js";
import "./chunk-WUU3EHOR.js";
import {
  __publicField,
  __require,
  __toESM
...
var __require2 = ((x) => typeof __require < "u" ? __require : typeof Proxy < "u" ? new Proxy(x, { get: (a, b2) => (typeof __require < "u" ? __require : a)[b2] }) : x)(function(x) {
...
var require_pathval = __commonJS({ "../../node_modules/pathval/index.js"(exports, module2) {
  ...
  function internalSetPathValue(obj, val, parsed) {
    for (var tempObj = obj, pathDepth = parsed.length, part = null, i = 0; i < pathDepth; i++) {
      ...
      if (part = parsed[i], i === pathDepth - 1) propName = typeof part.p > "u" ? part.i : part.p, tempObj[propName] = val;
...
var require_check_error = __commonJS({ "../../node_modules/check-error/index.js"(exports, module2) {
  ...
  module2.exports = { compatibleInstance, compatibleConstructor, compatibleMessage, getMessage: getMessage2, getConstructorName };
} });
  ...
  module2.exports = function(chai2, _) {
    ...
    function include(val, msg) {
      ...
      switch (objType) {
        ...
        case "array":
          ...
          break;
        default:
          if (val !== Object(val)) throw new AssertionError2(flagMsg + "the given combination of arguments (" + objType + " and " + _.type(val).toLowerCase() + ") is invalid for this assertion. You can use an array, a map, an object, a set, a string, or a weakset instead of a " + _.type(val).toLowerCase(), void 0, ssfi);
          ...
          if (props.forEach(function(prop) {
            ...
            try {
              ...
              if (!_.checkError.compatibleConstructor(err, AssertionError2)) throw err;
    ...
    Assertion2.addProperty("exist", assertExist), Assertion2.addProperty("exists", assertExist), Assertion2.addProperty("empty", function() {
      ...
      switch (flagMsg = flagMsg ? flagMsg + ": " : "", _.type(val).toLowerCase()) {
        ...
        default:
          if (val !== Object(val)) throw new AssertionError2(flagMsg + ".empty was passed non-string primitive " + _.inspect(val), void 0, ssfi);
    ...
    function assertProperty(name, val, msg) {
      ...
      var hasProperty;
      isOwn ? hasProperty = Object.prototype.hasOwnProperty.call(obj, name) : isNested ? hasProperty = pathInfo.exists : hasProperty = _.hasProperty(obj, name), (!negate || arguments.length === 1) && this.assert(hasProperty, "expected #{this} to have " + descriptor + _.inspect(name), "expected #{this} to not have " + descriptor + _.inspect(name)), arguments.length > 1 && this.assert(hasProperty && isEql(val, value), "expected #{this} to have " + descriptor + _.inspect(name) + " of #{exp}, but got #{act}", "expected #{this} to not have " + descriptor + _.inspect(name) + " of #{act}", val, value), flag(this, "object", value);
    }
    ...
    function assertOwnPropertyDescriptor(name, descriptor, msg) {
      ...
      actualDescriptor && descriptor ? this.assert(eql(descriptor, actualDescriptor), "expected the own property descriptor for " + _.inspect(name) + " on #{this} to match " + _.inspect(descriptor) + ", got " + _.inspect(actualDescriptor), "expected the own property descriptor for " + _.inspect(name) + " on #{this} to not match " + _.inspect(descriptor), descriptor, actualDescriptor, true) : this.assert(actualDescriptor, "expected #{this} to have an own property descriptor for " + _.inspect(name), "expected #{this} to not have an own property descriptor for " + _.inspect(name)), flag(this, "object", actualDescriptor);
    }
    ...
    function assertKeys(keys2) {
      ...
      if (!keys2.length) throw new AssertionError2(flagMsg + "keys required", void 0, ssfi);
    ...
    function satisfy(matcher, msg) {
      ...
      this.assert(result, "expected #{this} to satisfy " + _.objDisplay(matcher), "expected #{this} to not satisfy" + _.objDisplay(matcher), !flag(this, "negate"), result);
    }
  ...
  function printIteratorEntries(iterator, config3, indentation, depth, refs, printer, separator = ": ") {
    ...
    if (!current.done) {
      ...
      for (; !current.done; ) {
        ...
        let name = printer(current.value[0], config3, indentationNext, depth, refs), value = printer(current.value[1], config3, indentationNext, depth, refs);
  ...
  function printIteratorValues(iterator, config3, indentation, depth, refs, printer) {
    ...
    if (!current.done) {
      ...
      for (; !current.done; ) {
        ...
        result += printer(current.value, config3, indentationNext, depth, refs), current = iterator.next(), current.done ? config3.min || (result += ",") : result += `,${config3.spacingInner}`;
      }
      result += config3.spacingOuter + indentation;
    }
    return result;
  ...
  function printListItems(list, config3, indentation, depth, refs, printer) {
    ...
    if (list.length) {
      ...
      for (let i = 0; i < list.length; i++) {
        ...
        i in list && (result += printer(list[i], config3, indentationNext, depth, refs)), i < list.length - 1 ? result += `,${config3.spacingInner}` : config3.min || (result += ",");
      }
      result += config3.spacingOuter + indentation;
    }
    return result;
...
var require_AsymmetricMatcher = __commonJS({ "../../node_modules/pretty-format/build/plugins/AsymmetricMatcher.js"(exports) {
  ...
  var _collections = require_collections(), Symbol2 = globalThis["jest-symbol-do-not-touch"] || globalThis.Symbol, asymmetricMatcher = typeof Symbol2 == "function" && Symbol2.for ? Symbol2.for("jest.asymmetricMatcher") : 1267621, SPACE = " ", serialize = (val, config3, indentation, depth, refs, printer) => {
    let stringedValue = val.toString();
    if (stringedValue === "ArrayContaining" || stringedValue === "ArrayNotContaining") return ++depth > config3.maxDepth ? `[${stringedValue}]` : `${stringedValue + SPACE}[${(0, _collections.printListItems)(val.sample, config3, indentation, depth, refs, printer)}]`;
    if (stringedValue === "ObjectContaining" || stringedValue === "ObjectNotContaining") return ++depth > config3.maxDepth ? `[${stringedValue}]` : `${stringedValue + SPACE}{${(0, _collections.printObjectProperties)(val.sample, config3, indentation, depth, refs, printer)}}`;
    if (stringedValue === "StringMatching" || stringedValue === "StringNotMatching" || stringedValue === "StringContaining" || stringedValue === "StringNotContaining") return stringedValue + SPACE + printer(val.sample, config3, indentation, depth, refs);
...
var require_DOMCollection = __commonJS({ "../../node_modules/pretty-format/build/plugins/DOMCollection.js"(exports) {
  ...
  var isNamedNodeMap = (collection) => collection.constructor.name === "NamedNodeMap", serialize = (collection, config3, indentation, depth, refs, printer) => {
    ...
    return ++depth > config3.maxDepth ? `[${name}]` : (config3.min ? "" : name + SPACE) + (OBJECT_NAMES.indexOf(name) !== -1 ? `{${(0, _collections.printObjectProperties)(isNamedNodeMap(collection) ? Array.from(collection).reduce((props, attribute) => (props[attribute.name] = attribute.value, props), {}) : { ...collection }, config3, indentation, depth, refs, printer)}}` : `[${(0, _collections.printListItems)(Array.from(collection), config3, indentation, depth, refs, printer)}]`);
  };
  exports.serialize = serialize;
  var plugin = { serialize, test }, _default = plugin;
  exports.default = _default;
...
`) !== -1 && (printed = config3.spacingOuter + indentationNext + printed + config3.spacingOuter + indentation), printed = `{${printed}}`), `${config3.spacingInner + indentation + colors.prop.open + key + colors.prop.close}=${colors.value.open}${printed}${colors.value.close}`;
  ...
  var printChildren2 = (children, config3, indentation, depth, refs, printer) => children.map((child) => config3.spacingOuter + indentation + (typeof child == "string" ? printText2(child, config3) : printer(child, config3, indentation, depth, refs))).join("");
...
var require_ReactElement = __commonJS({ "../../node_modules/pretty-format/build/plugins/ReactElement.js"(exports) {
  ...
  }, serialize = (element, config3, indentation, depth, refs, printer) => ++depth > config3.maxDepth ? (0, _markup.printElementAsLeaf)(getType3(element), config3) : (0, _markup.printElement)(getType3(element), (0, _markup.printProps)(getPropKeys(element), element.props, config3, indentation + config3.indent, depth, refs, printer), (0, _markup.printChildren)(getChildren(element.props.children), config3, indentation + config3.indent, depth, refs, printer), config3, indentation);
  exports.serialize = serialize;
...
var require_ReactTestComponent = __commonJS({ "../../node_modules/pretty-format/build/plugins/ReactTestComponent.js"(exports) {
  ...
  }, serialize = (object, config3, indentation, depth, refs, printer) => ++depth > config3.maxDepth ? (0, _markup.printElementAsLeaf)(object.type, config3) : (0, _markup.printElement)(object.type, object.props ? (0, _markup.printProps)(getPropKeys(object), object.props, config3, indentation + config3.indent, depth, refs, printer) : "", object.children ? (0, _markup.printChildren)(object.children, config3, indentation + config3.indent, depth, refs, printer) : "", config3, indentation);
  exports.serialize = serialize;
...
var require_build = __commonJS({ "../../node_modules/pretty-format/build/index.js"(exports) {
  ...
  function printPlugin(plugin, val, config3, indentation, depth, refs) {
    let printed;
    try {
      printed = isNewPlugin(plugin) ? plugin.serialize(val, config3, indentation, depth, refs, printer) : plugin.print(val, (valChild) => printer(valChild, config3, indentation, depth, refs), (str) => {
        let indentationNext = indentation + config3.indent;
...
${indentationNext}`);
  ...
  function printer(val, config3, indentation, depth, refs, hasCalledToJSON) {
    ...
    if (plugin !== null) return printPlugin(plugin, val, config3, indentation, depth, refs);
...
` });
  ...
  function format4(val, options) {
    if (options && (validateOptions(options), options.plugins)) {
      ...
      if (plugin !== null) return printPlugin(plugin, val, getConfig3(options), "", 0, []);
    }
...
var require_isEqual = __commonJS({ "../../node_modules/lodash/isEqual.js"(exports, module2) {
...
var require_isArguments2 = __commonJS({ "../../node_modules/object-keys/isArguments.js"(exports, module2) {
...
var require_implementation = __commonJS({ "../../node_modules/object-keys/implementation.js"(exports, module2) {
  var keysShim;
  Object.keys || (has = Object.prototype.hasOwnProperty, toStr3 = Object.prototype.toString, isArgs = require_isArguments2(), isEnumerable = Object.prototype.propertyIsEnumerable, hasDontEnumBug = !isEnumerable.call({ toString: null }, "toString"), hasProtoEnumBug = isEnumerable.call(function() {
    ...
    else for (var name in object) !(skipProto && name === "prototype") && has.call(object, name) && theKeys.push(String(name));
    if (hasDontEnumBug) for (var skipConstructor = equalsConstructorPrototypeIfNotBuggy(object), k = 0; k < dontEnums.length; ++k) !(skipConstructor && dontEnums[k] === "constructor") && has.call(object, dontEnums[k]) && theKeys.push(dontEnums[k]);
    return theKeys;
  });
  var has, toStr3, isArgs, isEnumerable, hasDontEnumBug, hasProtoEnumBug, dontEnums, equalsConstructorPrototype, excludedKeys, hasAutomationEqualityBug, equalsConstructorPrototypeIfNotBuggy;
...
var require_define_properties = __commonJS({ "../../node_modules/define-properties/index.js"(exports, module2) {
  var keys2 = require_object_keys(), hasSymbols = typeof Symbol == "function" && typeof Symbol("foo") == "symbol", toStr3 = Object.prototype.toString, concat = Array.prototype.concat, defineDataProperty = require_define_data_property(), isFunction = function(fn3) {
  ...
  module2.exports = function(target, source1) {
    ...
    for (var s = 1; s < arguments.length; ++s) {
      ...
      if (getSymbols) for (var syms = getSymbols(from), j = 0; j < syms.length; ++j) {
        var key = syms[j];
        $propIsEnumerable(from, key) && $push(keys2, key);
      }
...
var require_object_inspect = __commonJS({ "../../node_modules/object-inspect/index.js"(exports, module2) {
  ...
  module2.exports = function inspect_(obj, options, depth, seen) {
    ...
    if (typeof obj == "function" && !isRegExp(obj)) {
      var name = nameOf(obj), keys2 = arrObjKeys(obj, inspect3);
...
` + indent.prev;
  ...
  function arrObjKeys(obj, inspect3) {
    ...
    for (var key in obj) has(obj, key) && (isArr && String(Number(key)) === key && key < obj.length || hasShammedSymbols && symMap["$" + key] instanceof Symbol || ($test.call(/[^\w$]/, key) ? xs.push(inspect3(key, obj) + ": " + inspect3(obj[key], obj)) : xs.push(key + ": " + inspect3(obj[key], obj))));
    if (typeof gOPS == "function") for (var j = 0; j < syms.length; j++) isEnumerable.call(obj, syms[j]) && xs.push("[" + inspect3(syms[j]) + "]: " + inspect3(obj[syms[j]], obj));
    return xs;
  }
} });
...
var require_internal_slot = __commonJS({ "../../node_modules/internal-slot/index.js"(exports, module2) {
  var hasOwn = require_hasown(), channel = require_side_channel()(), $TypeError = require_type(), SLOT = { assert: function(O, slot) {
    ...
    if (channel.assert(O), !SLOT.has(O, slot)) throw new $TypeError("`" + slot + "` is not present on `O`");
  }, get: function(O, slot) {
    if (!O || typeof O != "object" && typeof O != "function") throw new $TypeError("`O` is not an object");
    if (typeof slot != "string") throw new $TypeError("`slot` must be a string");
  ...
  module2.exports = function(origIterator) {
    ...
    var siIterator = { next: function() {
      ...
      try {
        ...
        if (SLOT.set(iterator, "[[Done]]", true), e !== $StopIteration) throw e;
        return { done: true, value: void 0 };
      }
    } };
...
var require_is_map = __commonJS({ "../../node_modules/is-map/index.js"(exports, module2) {
  ...
  module2.exports = exported || function(x) {
...
var require_es_get_iterator = __commonJS({ "../../node_modules/es-get-iterator/index.js"(exports, module2) {
  ...
  require_has_symbols()() || require_shams()() ? ($iterator = Symbol.iterator, module2.exports = function(iterable) {
  ...
  }) : (isArray = require_isarray(), isString = require_is_string(), GetIntrinsic = require_get_intrinsic(), $Map = GetIntrinsic("%Map%", true), $Set = GetIntrinsic("%Set%", true), callBound = require_callBound(), $arrayPush = callBound("Array.prototype.push"), $charCodeAt = callBound("String.prototype.charCodeAt"), $stringSlice = callBound("String.prototype.slice"), advanceStringIndex = function(S, index) {
    var length = S.length;
    ...
    return { next: function() {
      var done = i >= arraylike.length, value;
    ...
    if (isString(iterable)) {
      var i = 0;
      return { next: function() {
        var nextIndex = advanceStringIndex(iterable, i), value = $stringSlice(iterable, i, nextIndex);
    ...
    if (isMap(iterable)) {
      ...
      if ($mapForEach) {
        var entries = [];
        return $mapForEach(iterable, function(v2, k) {
...
var require_is_weakmap = __commonJS({ "../../node_modules/is-weakmap/index.js"(exports, module2) {
  ...
  module2.exports = exported || function(x) {
    if (!x || typeof x != "object") return false;
    try {
      if ($mapHas.call(x, $mapHas), $setHas) try {
...
var require_is_weakset = __commonJS({ "../../node_modules/is-weakset/index.js"(exports, module2) {
  ...
  $setHas ? ($mapHas = callBound("WeakMap.prototype.has", true), module2.exports = function(x) {
    if (!x || typeof x != "object") return false;
    try {
      if ($setHas(x, $setHas), $mapHas) try {
        $mapHas(x, $mapHas);
      } catch {
        return true;
      }
...
var require_for_each = __commonJS({ "../../node_modules/for-each/index.js"(exports, module2) {
  var isCallable3 = require_is_callable(), toStr3 = Object.prototype.toString, hasOwnProperty = Object.prototype.hasOwnProperty, forEachArray = function(array, iterator, receiver) {
    for (var i = 0, len = array.length; i < len; i++) hasOwnProperty.call(array, i) && (receiver == null ? iterator(array[i], i, array) : iterator.call(receiver, array[i], i, array));
  }, forEachString = function(string2, iterator, receiver) {
    for (var i = 0, len = string2.length; i < len; i++) receiver == null ? iterator(string2.charAt(i), i, string2) : iterator.call(receiver, string2.charAt(i), i, string2);
  }, forEachObject = function(object, iterator, receiver) {
    for (var k in object) hasOwnProperty.call(object, k) && (receiver == null ? iterator(object[k], k, object) : iterator.call(receiver, object[k], k, object));
...
var require_available_typed_arrays = __commonJS({ "../../node_modules/available-typed-arrays/index.js"(exports, module2) {
  ...
  module2.exports = function() {
    for (var out = [], i = 0; i < possibleNames.length; i++) typeof g2[possibleNames[i]] == "function" && (out[out.length] = possibleNames[i]);
    return out;
  };
} });
...
var require_deep_equal = __commonJS({ "../../node_modules/deep-equal/index.js"(exports, module2) {
  ...
  function setHasEqualElement(set, val1, opts, channel) {
    for (var i = getIterator(set), result; (result = i.next()) && !result.done; ) if (internalDeepEqual(val1, result.value, opts, channel)) return $setDelete(set, result.value), true;
    return false;
  }
  ...
  function mapHasEqualEntry(set, map, key1, item1, opts, channel) {
    for (var i = getIterator(set), result, key2; (result = i.next()) && !result.done; ) if (key2 = result.value, internalDeepEqual(key1, key2, opts, channel) && internalDeepEqual(item1, $mapGet(map, key2), opts, channel)) return $setDelete(set, key2), true;
    return false;
  }
  ...
  function objEquiv(a, b2, opts, channel) {
    ...
    if (aWhich || bWhich) {
      ...
      for (i = 0; i < a.length; i++) if (a[i] !== b2[i]) return false;
      return true;
    }
    ...
    for (ka.sort(), kb.sort(), i = ka.length - 1; i >= 0; i--) if (ka[i] != kb[i]) return false;
    for (i = ka.length - 1; i >= 0; i--) if (key = ka[i], !internalDeepEqual(a[key], b2[key], opts, channel)) return false;
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
  ...
  for (i = 0; i < keys2.length; i++) if (key = keys2[i], role = _rolesMap.default.get(key), role) for (concepts = [].concat(role.baseConcepts, role.relatedConcepts), k = 0; k < concepts.length; k++) relation = concepts[k], relation.module === "HTML" && (concept = relation.concept, concept && function() {
  ...
  var key, role, concepts, relation, concept, k, i, elementRoleMap = { entries: function() {
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
  ...
  var roleElement = [], keys2 = _rolesMap.default.keys(), _loop = function(i2) {
    var key = keys2[i2], role = _rolesMap.default.get(key);
    if (role) for (var concepts = [].concat(role.baseConcepts, role.relatedConcepts), k = 0; k < concepts.length; k++) {
      ...
      if (relation.module === "HTML") {
        ...
        if (concept) {
          ...
          roleElementRelation ? relationConcepts = roleElementRelation[1] : relationConcepts = [], relationConcepts.push(concept), roleElement.push([key, relationConcepts]);
        }
      }
    }
  };
  for (i = 0; i < keys2.length; i++) _loop(i);
  var i, roleElementMap = { entries: function() {
    ...
    try {
      for (_iterator.s(); !(_step = _iterator.n()).done; ) {
        var _step$value = _slicedToArray(_step.value, 2), key = _step$value[0], values = _step$value[1];
        fn3.call(thisArg, values, key, roleElement);
      }
    } catch (err) {
      _iterator.e(err);
    } finally {
...
var require_conversions = __commonJS({ "../../node_modules/color-convert/conversions.js"(exports, module2) {
  ...
  convert.hsl.rgb = function(hsl) {
    ...
    for (let i = 0; i < 3; i++) t3 = h + 1 / 3 * -(i - 1), t3 < 0 && t3++, t3 > 1 && t3--, 6 * t3 < 1 ? val = t1 + (t2 - t1) * 6 * t3 : 2 * t3 < 1 ? val = t2 : 3 * t3 < 2 ? val = t1 + (t2 - t1) * (2 / 3 - t3) * 6 : val = t1, rgb[i] = val * 255;
    return rgb;
  };
  ...
  convert.hsv.rgb = function(hsv) {
    let h = hsv[0] / 60, s = hsv[1] / 100, v2 = hsv[2] / 100, hi = Math.floor(h) % 6, f = h - Math.floor(h), p2 = 255 * v2 * (1 - s), q = 255 * v2 * (1 - s * f), t = 255 * v2 * (1 - s * (1 - f));
    switch (v2 *= 255, hi) {
      case 0:
        return [v2, t, p2];
      case 1:
  ...
  convert.rgb.ansi16 = function(args, saturation = null) {
    let [r, g2, b2] = args, value = saturation === null ? convert.rgb.hsv(args)[2] : saturation;
  ...
  convert.rgb.ansi256 = function(args) {
    let r = args[0], g2 = args[1], b2 = args[2];
  ...
  convert.ansi16.rgb = function(args) {
    ...
    let mult = (~~(args > 50) + 1) * 0.5, r = (color & 1) * mult * 255, g2 = (color >> 1 & 1) * mult * 255, b2 = (color >> 2 & 1) * mult * 255;
    return [r, g2, b2];
  };
  convert.ansi256.rgb = function(args) {
    ...
    args -= 16;
    let rem, r = Math.floor(args / 36) / 5 * 255, g2 = Math.floor((rem = args % 36) / 6) / 5 * 255, b2 = rem % 6 / 5 * 255;
    return [r, g2, b2];
  };
  ...
  convert.hsv.hcg = function(hsv) {
    let s = hsv[1] / 100, v2 = hsv[2] / 100, c = s * v2, f = 0;
    return c < 1 && (f = (v2 - c) / (1 - c)), [hsv[0], c * 100, f * 100];
  };
  convert.hcg.rgb = function(hcg) {
    let h = hcg[0] / 360, c = hcg[1] / 100, g2 = hcg[2] / 100;
    if (c === 0) return [g2 * 255, g2 * 255, g2 * 255];
  ...
  convert.hcg.hsv = function(hcg) {
    let c = hcg[1] / 100, g2 = hcg[2] / 100, v2 = c + g2 * (1 - c), f = 0;
    return v2 > 0 && (f = c / v2), [hcg[0], f * 100, v2 * 100];
  };
...
var require_ansi_styles2 = __commonJS({ "../../node_modules/ansi-styles/index.js"(exports, module2) {
  ...
  }, ansi2ansi = (n) => n, rgb2rgb = (r, g2, b2) => [r, g2, b2], setLazyProperty = (object, property, get) => {
...
var require_source = __commonJS({ "node_modules/@testing-library/jest-dom/node_modules/chalk/source/index.js"(exports, module2) {
  var ansiStyles = require_ansi_styles2(), { stdout: stdoutColor, stderr: stderrColor } = require_browser(), { stringReplaceAll, stringEncaseCRLFWithFirstIndex } = require_util2(), levelMapping = ["ansi", "ansi", "ansi256", "ansi16m"], styles = /* @__PURE__ */ Object.create(null), applyOptions = (object, options = {}) => {
  ...
  for (let [styleName, style] of Object.entries(ansiStyles)) styles[styleName] = { get() {
...
var require_baseFindIndex = __commonJS({ "../../node_modules/lodash/_baseFindIndex.js"(exports, module2) {
...
var require_baseIsNaN = __commonJS({ "../../node_modules/lodash/_baseIsNaN.js"(exports, module2) {
  function baseIsNaN(value) {
    return value !== value;
  }
  module2.exports = baseIsNaN;
} });
var require_strictIndexOf = __commonJS({ "../../node_modules/lodash/_strictIndexOf.js"(exports, module2) {
...
var require_baseIndexOf = __commonJS({ "../../node_modules/lodash/_baseIndexOf.js"(exports, module2) {
...
var require_arrayIncludes = __commonJS({ "../../node_modules/lodash/_arrayIncludes.js"(exports, module2) {
...
var require_arrayIncludesWith = __commonJS({ "../../node_modules/lodash/_arrayIncludesWith.js"(exports, module2) {
  function arrayIncludesWith(array, value, comparator) {
    for (var index = -1, length = array == null ? 0 : array.length; ++index < length; ) if (comparator(value, array[index])) return true;
    return false;
  }
  module2.exports = arrayIncludesWith;
} });
var require_noop = __commonJS({ "../../node_modules/lodash/noop.js"(exports, module2) {
  function noop2() {
  }
  module2.exports = noop2;
} });
var require_createSet = __commonJS({ "../../node_modules/lodash/_createSet.js"(exports, module2) {
  var Set2 = require_Set(), noop2 = require_noop(), setToArray = require_setToArray(), INFINITY = 1 / 0, createSet = Set2 && 1 / setToArray(new Set2([, -0]))[1] == INFINITY ? function(values) {
    return new Set2(values);
  } : noop2;
  module2.exports = createSet;
} });
var require_baseUniq = __commonJS({ "../../node_modules/lodash/_baseUniq.js"(exports, module2) {
...
var require_uniq = __commonJS({ "../../node_modules/lodash/uniq.js"(exports, module2) {
...
var require_ansi_styles3 = __commonJS({ "node_modules/pretty-format/node_modules/ansi-styles/index.js"(exports, module2) {
  var wrapAnsi256 = (offset = 0) => (code) => `\x1B[${38 + offset};5;${code}m`, wrapAnsi16m = (offset = 0) => (red, green, blue) => `\x1B[${38 + offset};2;${red};${green};${blue}m`;
  function assembleStyles() {
    let codes = /* @__PURE__ */ new Map(), styles = { modifier: { reset: [0, 0], bold: [1, 22], dim: [2, 22], italic: [3, 23], underline: [4, 24], overline: [53, 55], inverse: [7, 27], hidden: [8, 28], strikethrough: [9, 29] }, color: { black: [30, 39], red: [31, 39], green: [32, 39], yellow: [33, 39], blue: [34, 39], magenta: [35, 39], cyan: [36, 39], white: [37, 39], blackBright: [90, 39], redBright: [91, 39], greenBright: [92, 39], yellowBright: [93, 39], blueBright: [94, 39], magentaBright: [95, 39], cyanBright: [96, 39], whiteBright: [97, 39] }, bgColor: { bgBlack: [40, 49], bgRed: [41, 49], bgGreen: [42, 49], bgYellow: [43, 49], bgBlue: [44, 49], bgMagenta: [45, 49], bgCyan: [46, 49], bgWhite: [47, 49], bgBlackBright: [100, 49], bgRedBright: [101, 49], bgGreenBright: [102, 49], bgYellowBright: [103, 49], bgBlueBright: [104, 49], bgMagentaBright: [105, 49], bgCyanBright: [106, 49], bgWhiteBright: [107, 49] } };
    styles.color.gray = styles.color.blackBright, styles.bgColor.bgGray = styles.bgColor.bgBlackBright, styles.color.grey = styles.color.blackBright, styles.bgColor.bgGrey = styles.bgColor.bgBlackBright;
...
var require_collections2 = __commonJS({ "node_modules/pretty-format/build/collections.js"(exports) {
  ...
  function printIteratorValues(iterator, config3, indentation, depth, refs, printer) {
    ...
    if (!current.done) {
      result += config3.spacingOuter;
      let indentationNext = indentation + config3.indent;
      for (; !current.done; ) result += indentationNext + printer(current.value, config3, indentationNext, depth, refs), current = iterator.next(), current.done ? config3.min || (result += ",") : result += "," + config3.spacingInner;
      result += config3.spacingOuter + indentation;
    }
    return result;
  }
  function printListItems(list, config3, indentation, depth, refs, printer) {
    ...
    if (list.length) {
      result += config3.spacingOuter;
      let indentationNext = indentation + config3.indent;
      for (let i = 0; i < list.length; i++) result += indentationNext, i in list && (result += printer(list[i], config3, indentationNext, depth, refs)), i < list.length - 1 ? result += "," + config3.spacingInner : config3.min || (result += ",");
      result += config3.spacingOuter + indentation;
    }
    return result;
  }
...
var require_DOMCollection2 = __commonJS({ "node_modules/pretty-format/build/plugins/DOMCollection.js"(exports) {
  Object.defineProperty(exports, "__esModule", { value: true });
  exports.test = exports.serialize = exports.default = void 0;
  var _collections = require_collections2(), SPACE = " ", OBJECT_NAMES = ["DOMStringMap", "NamedNodeMap"], ARRAY_REGEXP = /^(HTML\w*Collection|NodeList)$/, testName = (name) => OBJECT_NAMES.indexOf(name) !== -1 || ARRAY_REGEXP.test(name), test = (val) => val && val.constructor && !!val.constructor.name && testName(val.constructor.name);
  exports.test = test;
  var isNamedNodeMap = (collection) => collection.constructor.name === "NamedNodeMap", serialize = (collection, config3, indentation, depth, refs, printer) => {
    let name = collection.constructor.name;
    return ++depth > config3.maxDepth ? "[" + name + "]" : (config3.min ? "" : name + SPACE) + (OBJECT_NAMES.indexOf(name) !== -1 ? "{" + (0, _collections.printObjectProperties)(isNamedNodeMap(collection) ? Array.from(collection).reduce((props, attribute) => (props[attribute.name] = attribute.value, props), {}) : { ...collection }, config3, indentation, depth, refs, printer) + "}" : "[" + (0, _collections.printListItems)(Array.from(collection), config3, indentation, depth, refs, printer) + "]");
...
var import_index = __toESM2(require_chai2(), 1);
...
var import_pretty_format3 = __toESM2(require_build(), 1);
...
function eq(a, b2, aStack, bStack, customTesters, hasKey2) {
  ...
  if (keys(b2, hasKey2).length !== size) return false;
  ...
  if (a.size !== void 0) {
    ...
    if (isA("Set", a) || isImmutableUnorderedSet(a)) {
      ...
      for (let aValue of a) if (!b2.has(aValue)) {
        let has = false;
        for (let bValue of b2) equals(aValue, bValue, filteredCustomTesters) === true && (has = true);
        if (has === false) {
          allFound = false;
          break;
        }
...
function wrapSoft(utils, fn3) {
  return function(...args) {
    ...
    if (!((test == null ? void 0 : test.context._local) ? test.context.expect.getState() : getState(globalThis[GLOBAL_EXPECT])).soft) return fn3.apply(this, args);
...
`), msg);
  def(["toHaveBeenCalledTimes", "toBeCalledTimes"], function(number) {
    ...
    this.assert(equals(nthCall, args, [...customTesters, iterableEquality]), `expected ${ordinalOf(times)} "${spyName}" call to have been called with #{exp}`, `expected ${ordinalOf(times)} "${spyName}" call to not have been called with #{exp}`, args, nthCall);
...
var import_isEqual = __toESM2(require_isEqual(), 1);
...
function arrayFrom(arrayLike, mapFn) {
  ...
  for (var len = toLength(items.length), A = isCallable(C2) ? Object(new C2(len)) : new Array(len), k = 0, kValue; k < len; ) kValue = items[k], mapFn ? A[k] = mapFn(kValue, k) : A[k] = kValue, k += 1;
...
var import_uniq = __toESM2(require_uniq(), 1);
...
function compareArraysAsSet(a, b2) {
  if (Array.isArray(a) && Array.isArray(b2)) return (0, import_isEqual.default)(new Set(a), new Set(b2));
}
...
function listenWhenCalled(mock) {
  ...
  return state.willCall((...args) => (listeners.forEach((listener) => listener(mock, args)), impl == null ? void 0 : impl(...args))), mock;
}
...
var prettyFormat = __toESM2(require_build3());
...
function arrayFrom2(arrayLike, mapFn) {
  ...
  for (var len = toLength2(items.length), A = isCallable2(C2) ? Object(new C2(len)) : new Array(len), k = 0, kValue; k < len; ) kValue = items[k], mapFn ? A[k] = mapFn(kValue, k) : A[k] = kValue, k += 1;
  return A.length = len, A;
}
...
function prettyDOM(dom, maxLength, options) {
  if (options === void 0 && (options = {}), dom || (dom = getDocument().body), typeof maxLength != "number" && (maxLength = typeof process < "u" && process.env.DEBUG_PRINT_LIMIT || 7e3), maxLength === 0) return "";
...
function buildElementRoleList2(elementRolesMap) {
  function makeElementSelector(_ref) {
    ...
    return "" + name + attributes.map((_ref2) => {
      ...
      return constraints.indexOf("undefined") !== -1 ? ":not([" + attributeName + "])" : value ? "[" + attributeName + '="' + value + '"]' : "[" + attributeName + "]";
    }).join("");
  }
...
function getSuggestedQuery(element, variant, method) {
  ...
  if (variant === void 0 && (variant = "get"), element.matches(getConfig().defaultIgnore)) return;
  ...
  if (role !== "generic" && canSuggest("Role", method, role)) return makeSuggestion("Role", element, role, { variant, name: computeAccessibleName2(element, { computedStyleSupportsPseudoElements: getConfig().computedStyleSupportsPseudoElements }) });
...
function makeGetAllQuery(allQuery, getMissingError2) {
  return function(container) {
    ...
    let els = allQuery(container, ...args);
    if (!els.length) throw getConfig().getElementError(getMissingError2(container, ...args), container);
    return els;
  };
}
...
var wrapSingleQueryWithSuggestion = (query, queryAllByName, variant) => function(container) {
  ...
  let element = query(container, ...args), [{ suggest = getConfig().throwSuggestions } = {}] = args.slice(-1);
  if (element && suggest) {
...
var wrapAllByQueryWithSuggestion = (query, queryAllByName, variant) => function(container) {
  ...
  let els = query(container, ...args), [{ suggest = getConfig().throwSuggestions } = {}] = args.slice(-1);
...
var queryAllByRole = function(container, role, _temp) {
  let { hidden = getConfig().defaultHidden, name, description, queryFallbacks = false, selected, busy, checked, pressed, current, level, expanded, value: { now: valueNow, min: valueMin, max: valueMax, text: valueText } = {} } = _temp === void 0 ? {} : _temp;
...
async function readDataTransferFromClipboard(document2) {
  ...
  for (let item of items) for (let type3 of item.types) dt.setData(type3, await item.getType(type3).then((b2) => readBlobText(b2, window2.FileReader)));
  return dt;
}
...
function createEvent2(type3, target, init) {
  ...
  return eventInitializer[EventType].forEach((f) => f(event, init ?? {})), event;
}
...
var Buttons = class {
  ...
  up(keyDef) {
    let button = getMouseButtonId(keyDef.button);
    if (button in this.pressed && (this.pressed[button] = this.pressed[button].filter((k) => k.name !== keyDef.name), this.pressed[button].length === 0)) return delete this.pressed[button], button;
  }
  constructor() {
...
async function releaseAllKeys(instance) {
  for (let k of instance.system.keyboard.getPressedKeys()) await instance.system.keyboard.keyup(instance, k);
}
function copySelection(target) {
  ...
  for (let type3 in data) data[type3] && dt.setData(type3, data[type3]);
  return dt;
}
...
async function selectOptionsBase(newValue, select, values) {
  if (!newValue && !select.multiple) throw getConfig().getElementError("Unable to deselect an option in a non-multiple select. Use selectOptions to change the selection instead.", select);
  ...
  } else throw getConfig().getElementError("Cannot select multiple options on a non-multiple select", select);
  ...
  else throw getConfig().getElementError("Cannot select options on elements that are neither select nor listbox elements", select);
}
...
async function upload(element, fileOrFiles) {
  ...
  let files = (Array.isArray(fileOrFiles) ? fileOrFiles : [fileOrFiles]).filter((file) => !this.config.applyAccept || isAcceptableFile(file, input2.accept)).slice(0, input2.multiple ? void 0 : 1), fileDialog = () => {
    var _input_files;
    files.length === ((_input_files = input2.files) === null || _input_files === void 0 ? void 0 : _input_files.length) && files.every((f, i) => {
      var _input_files2;
...
testingLibrary.screen = new Proxy(testingLibrary.screen, { get(target, prop, receiver) {
  return import_client_logger.once.warn(esm_default`
...
var traverseArgs = (value, depth = 0, key) => {
  ...
  if (typeof value == "object" && value.constructor === Object) {
    depth++;
    for (let [k, v2] of Object.entries(value)) ((_a = Object.getOwnPropertyDescriptor(value, k)) == null ? void 0 : _a.writable) && (value[k] = traverseArgs(v2, depth, k));
    return value;
  }
  return value;
};
