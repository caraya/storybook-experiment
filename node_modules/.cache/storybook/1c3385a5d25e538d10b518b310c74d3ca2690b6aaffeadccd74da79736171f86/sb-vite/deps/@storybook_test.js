...
var require_assertion_error = __commonJS({ "../../node_modules/assertion-error/index.js"(exports, module2) {
  function exclude() {
    ...
    return function() {
      for (var args = [].slice.call(arguments), i = 0, res = {}; i < args.length; i++)
...
`);
    ...
    function inspect3(value, options) {
      ...
      if (type3 === "object" && (type3 = toString$1.call(value).slice(8, -1)), baseTypesMap[type3])
...
var require_AsymmetricMatcher = __commonJS({ "../../node_modules/pretty-format/build/plugins/AsymmetricMatcher.js"(exports) {
  ...
  var _collections = require_collections(), Symbol2 = globalThis["jest-symbol-do-not-touch"] || globalThis.Symbol, asymmetricMatcher = typeof Symbol2 == "function" && Symbol2.for ? Symbol2.for("jest.asymmetricMatcher") : 1267621, SPACE = " ", serialize = (val, config3, indentation, depth, refs, printer) => {
    ...
    if (stringedValue === "ArrayContaining" || stringedValue === "ArrayNotContaining")
      return ++depth > config3.maxDepth ? `[${stringedValue}]` : `${stringedValue + SPACE}[${(0, _collections.printListItems)(val.sample, config3, indentation, depth, refs, printer)}]`;
    if (stringedValue === "ObjectContaining" || stringedValue === "ObjectNotContaining")
      return ++depth > config3.maxDepth ? `[${stringedValue}]` : `${stringedValue + SPACE}{${(0, _collections.printObjectProperties)(val.sample, config3, indentation, depth, refs, printer)}}`;
...
var require_indent_string = __commonJS({ "../../node_modules/indent-string/index.js"(exports, module2) {
  module2.exports = (string2, count = 1, options) => {
    if (options = { indent: " ", includeEmptyLines: false, ...options }, typeof string2 != "string")
...
` + indent.prev;
  ...
  function arrObjKeys(obj, inspect3) {
    ...
    for (var key in obj)
      has(obj, key) && (isArr && String(Number(key)) === key && key < obj.length || hasShammedSymbols && symMap["$" + key] instanceof Symbol || ($test.call(/[^\w$]/, key) ? xs.push(inspect3(key, obj) + ": " + inspect3(obj[key], obj)) : xs.push(key + ": " + inspect3(obj[key], obj))));
  ...
  module2.exports = function(origIterator) {
    ...
    var siIterator = { next: function() {
      ...
      try {
        ...
        if (SLOT.set(iterator, "[[Done]]", true), e !== $StopIteration)
          throw e;
        return { done: true, value: void 0 };
      }
    } };
...
var require_es_get_iterator = __commonJS({ "../../node_modules/es-get-iterator/index.js"(exports, module2) {
  ...
  require_has_symbols()() || require_shams()() ? ($iterator = Symbol.iterator, module2.exports = function(iterable) {
    ...
    if (noPrimordialCollections && typeof iterable["_es6-shim iterator_"] < "u")
...
var require_deep_equal = __commonJS({ "../../node_modules/deep-equal/index.js"(exports, module2) {
  ...
  function setHasEqualElement(set, val1, opts, channel) {
    for (var i = getIterator(set), result; (result = i.next()) && !result.done; )
      if (internalDeepEqual(val1, result.value, opts, channel))
        return $setDelete(set, result.value), true;
    return false;
  }
  ...
  function mapHasEqualEntry(set, map, key1, item1, opts, channel) {
    for (var i = getIterator(set), result, key2; (result = i.next()) && !result.done; )
      if (key2 = result.value, internalDeepEqual(key1, key2, opts, channel) && internalDeepEqual(item1, $mapGet(map, key2), opts, channel))
        return $setDelete(set, key2), true;
    return false;
  }
  ...
  function setEquiv(a, b2, opts, channel) {
    if ($setSize(a) !== $setSize(b2))
      return false;
    for (var iA = getIterator(a), iB = getIterator(b2), resultA, resultB, set; (resultA = iA.next()) && !resultA.done; )
  ...
  function mapEquiv(a, b2, opts, channel) {
    if ($mapSize(a) !== $mapSize(b2))
      return false;
    for (var iA = getIterator(a), iB = getIterator(b2), resultA, resultB, set, key, item1, item2; (resultA = iA.next()) && !resultA.done; )
      if (key = resultA.value[0], item1 = resultA.value[1], key && typeof key == "object")
        ...
        if (opts.strict || !mapMightHaveLoosePrim(a, b2, key, item1, opts, channel))
          return false;
        set || (set = new $Set()), $setAdd(set, key);
      }
    if (set) {
      for (; (resultB = iB.next()) && !resultB.done; )
        if (key = resultB.value[0], item2 = resultB.value[1], key && typeof key == "object") {
  ...
  function objEquiv(a, b2, opts, channel) {
    ...
    for (i = ka.length - 1; i >= 0; i--)
      if (key = ka[i], !internalDeepEqual(a[key], b2[key], opts, channel))
        return false;
  ...
  function parseArguments(name, arguments_) {
    ...
    for (let chunk of chunks) {
      ...
      if (!Number.isNaN(number))
        ...
        results.push(matches3[2].replace(ESCAPE_REGEX, (m2, escape2, character) => escape2 ? unescape(escape2) : character));
      else
...
function buildElementRoleList(elementRolesMap) {
  ...
  for (let [element, roles3] of elementRolesMap.entries())
    result = [...result, { match: match(element), roles: Array.from(roles3), specificity: getSelectorSpecificity(element) }];
...
function prettyDOM(dom, maxLength, options) {
  if (options === void 0 && (options = {}), dom || (dom = getDocument().body), typeof maxLength != "number" && (maxLength = typeof process < "u" && process.env.DEBUG_PRINT_LIMIT || 7e3), maxLength === 0)
    return "";
...
var traverseArgs = (value, depth = 0, key) => {
  ...
  if (typeof value == "object" && value.constructor === Object) {
    depth++;
    for (let [k, v2] of Object.entries(value))
      ((_a = Object.getOwnPropertyDescriptor(value, k)) == null ? void 0 : _a.writable) && (value[k] = traverseArgs(v2, depth, k));
    return value;
  }
  return value;
};
