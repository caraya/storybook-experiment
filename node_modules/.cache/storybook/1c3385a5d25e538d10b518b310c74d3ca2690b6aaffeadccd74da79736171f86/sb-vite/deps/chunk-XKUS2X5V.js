...
var I = (r, e, n, t) => {
  if (e && typeof e == "object" || typeof e == "function") for (let a of F(e)) !w.call(r, a) && a !== n && u(r, a, { get: () => e[a], enumerable: !(t = C(e, a)) || t.enumerable });
  return r;
};
      ...
      return function i(o, s, d) {
        ...
        switch (l.slice(8, -1)) {
          ...
          case "Map":
            ...
            do
              if (!i((p = y.next()).value, g.next().value, d)) return false;
            while (!p.done);
            return true;
          case "ArrayBuffer":
          ...
          case "Array":
            ...
            for (p = 0; p < o.length; p++) if ((p in o || p in s) && (p in o != p in s || !i(o[p], s[p], d))) return false;
            return true;
          case "Object":
            return i(e(o), e(s), d);
          default:
...
//# sourceMappingURL=chunk-XKUS2X5V.js.map
