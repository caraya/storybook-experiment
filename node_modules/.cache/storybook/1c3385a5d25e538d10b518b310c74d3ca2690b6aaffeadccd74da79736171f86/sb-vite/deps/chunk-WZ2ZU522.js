...
} from "./chunk-HTQIX5WB.js";
import {
  SNIPPET_RENDERED,
  SourceType
} from "./chunk-MMK5LFSX.js";
import {
...
import {
  ...
  rgba
} from "./chunk-U7H7JOGI.js";
import {
  require_react
} from "./chunk-KXNHAWZJ.js";
import {
  require_pickBy
} from "./chunk-HDLTD6LW.js";
import {
  require_uniq
} from "./chunk-6ZKYOT4L.js";
import {
  require_cloneDeep
} from "./chunk-MFLIYOO5.js";
import {
  __commonJS,
  __toESM
...
var Preview = ({ isLoading, isColumn, columns, children, withSource, withToolbar = false, isExpanded = false, additionalActions, className, layout = "padded", ...props }) => {
  let [expanded, setExpanded] = (0, import_react.useState)(isExpanded), { source, actionItem } = getSource(withSource, expanded, setExpanded), [scale, setScale] = (0, import_react.useState)(1), previewClasses = [className].concat(["sbdocs", "sbdocs-preview", "sb-unstyled"]), defaultActionItems = withSource ? [actionItem] : [], [additionalActionItems, setAdditionalActionItems] = (0, import_react.useState)(additionalActions ? [...additionalActions] : []), actionItems = [...defaultActionItems, ...additionalActionItems], { window: globalWindow4 } = import_global.global, copyToClipboard = (0, import_react.useCallback)(async (text) => {
    let { createCopyToClipboardFunction } = await import("./dist-YKAREL2S.js");
...
var BooleanControl = ({ name, value: value2, onChange, onBlur, onFocus, argType }) => {
  ...
  if (value2 === void 0)
    return import_react.default.createElement(Button, { variant: "outline", size: "medium", id: getControlSetterButtonId(name), onClick: onSetFalse, disabled: readonly }, "Set boolean");
...
var ObjectControl = ({ name, value: value2, onChange, argType }) => {
  ...
  if ((0, import_react.useEffect)(() => {
    ...
    return import_react.default.createElement(Button, { disabled: readonly, id: getControlSetterButtonId(name), onClick: onForceVisible }, "Set object");
...
var TextControl = ({ name, value: value2, onChange, onFocus, onBlur, maxLength, argType }) => {
  ...
  if (value2 === void 0)
    return import_react.default.createElement(Button, { variant: "outline", size: "medium", disabled: readonly, id: getControlSetterButtonId(name), onClick: onForceVisible }, "Set string");
...
var LazyColorControl = (0, import_react.lazy)(() => import("./Color-PRSJMWNM-X4GSJAYQ.js"));
...
//# sourceMappingURL=chunk-WZ2ZU522.js.map
