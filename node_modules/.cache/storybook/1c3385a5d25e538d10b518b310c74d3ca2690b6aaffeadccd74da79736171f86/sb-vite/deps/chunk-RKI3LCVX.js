  ...
  function equal(a, b) {
    ...
    if (a && b && typeof a == "object" && typeof b == "object") {
      ...
      if (hasMap && a instanceof Map && b instanceof Map) {
        ...
        for (it = a.entries(); !(i = it.next()).done; ) if (!b.has(i.value[0])) return false;
        for (it = a.entries(); !(i = it.next()).done; ) if (!equal(i.value[1], b.get(i.value[0]))) return false;
        return true;
      }
      ...
      for (i = length; i-- !== 0; ) if (!((keys[i] === "_owner" || keys[i] === "__v" || keys[i] === "__o") && a.$$typeof) && !equal(a[keys[i]], b[keys[i]])) return false;
      return true;
    }
    return a !== a && b !== b;
  }
...
var Tooltip = import_react.default.forwardRef(({ placement = "top", hasChrome = true, children, arrowProps = {}, tooltipRef, color, withArrows, ...props }, ref) => import_react.default.createElement(Wrapper, { "data-testid": "tooltip", hasChrome, ref, ...props, color }, hasChrome && withArrows && import_react.default.createElement(Arrow, { placement, ...arrowProps, color }), children));
...
//# sourceMappingURL=chunk-RKI3LCVX.js.map
