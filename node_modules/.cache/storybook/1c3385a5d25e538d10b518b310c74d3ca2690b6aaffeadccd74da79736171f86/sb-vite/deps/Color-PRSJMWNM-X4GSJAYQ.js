import {
  require_throttle
} from "./chunk-6EGAZUNQ.js";
import "./chunk-4VYWXRUH.js";
import {
  getControlId
...
import "./chunk-3EYUMWPK.js";
import "./chunk-VSGNFJNU.js";
import {
  newStyled
} from "./chunk-MCJC5UTA.js";
import "./chunk-2RUNVCRJ.js";
import "./chunk-5NOHXVXK.js";
import "./chunk-UXCGS74S.js";
import "./chunk-G5FW65QQ.js";
import "./chunk-AO4QRNHD.js";
import "./chunk-SJ46GW5Y.js";
import "./chunk-BOZK2MRR.js";
import {
  require_react
} from "./chunk-KXNHAWZJ.js";
import {
  require_color_convert
} from "./chunk-D6HF6AJY.js";
...
var Wrapper = newStyled.div({ position: "relative", maxWidth: 250, '&[aria-readonly="true"]': { opacity: 0.5 } });
var PickerTooltip = newStyled(WithTooltip)({ position: "absolute", zIndex: 1, top: 4, left: 4, "[aria-readonly=true] &": { cursor: "not-allowed" } });
...
var Input = newStyled(Form.Input)(({ theme, readOnly }) => ({ width: "100%", paddingLeft: 30, paddingRight: 30, boxSizing: "border-box", fontFamily: theme.typography.fonts.base }));
var ToggleIcon = newStyled(MarkupIcon)(({ theme }) => ({ position: "absolute", zIndex: 1, top: 6, right: 7, width: 20, height: 20, padding: 4, boxSizing: "border-box", cursor: "pointer", color: theme.input.color }));
...
var ColorControl = ({ name, value: initialValue, onChange, onFocus, onBlur, presetColors, startOpen = false, argType }) => {
  var _a;
  let throttledOnChange = (0, import_react2.useCallback)((0, import_throttle.default)(onChange, 200), [onChange]), { value, realValue, updateValue, color, colorSpace, cycleColorSpace } = useColorInput(initialValue, throttledOnChange), { presets, addPreset } = usePresets(presetColors, color, colorSpace), Picker = ColorPicker[colorSpace], readonly = !!((_a = argType == null ? void 0 : argType.table) == null ? void 0 : _a.readonly);
...
//# sourceMappingURL=Color-PRSJMWNM-X4GSJAYQ.js.map
