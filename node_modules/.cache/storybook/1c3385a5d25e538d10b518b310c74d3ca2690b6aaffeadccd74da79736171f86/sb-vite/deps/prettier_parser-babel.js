  ...
  "node_modules/prettier/plugins/babel.js"(exports, module) {
    (function(f) {
      ...
      var Lt = (a, t) => () => (t || a((t = { exports: {} }).exports, t), t.exports), Qs = (a, t) => {
        for (var e in t) we(a, e, { get: t[e], enumerable: true });
      }, Dt = (a, t, e, s) => {
        if (t && typeof t == "object" || typeof t == "function") for (let i of Xs(t)) !Ys.call(a, i) && i !== e && we(a, i, { get: () => t[i], enumerable: !(s = Js(t, i)) || s.enumerable });
        return a;
      };
...
`);
        ...
        function as(a, t, e, s, i, r, n, o, h, l) {
          ...
          for (let I = 0, C = r ?? 1 / 0; I < C; ++I) {
            ...
            if (E >= 97 ? k = E - 97 + 10 : E >= 65 ? k = E - 65 + 10 : Oi(E) ? k = E - 48 : k = 1 / 0, k >= i) {
              if (k <= 9 && l) return { n: null, pos: t };
              if (k <= 9 && h.invalidDigit(t, e, s, i)) k = 0;
              else if (n) k = 0, d = true;
              else break;
            }
            ++t, y = y * i + k;
          }
        ...
        var Ri = /* @__PURE__ */ new Set([103, 109, 115, 105, 121, 117, 100, 118]), O = class {
          ...
          readNumber(t) {
            ...
            if (c === 46 && !h && (++this.state.pos, this.readInt(10), i = true, c = this.input.charCodeAt(this.state.pos)), (c === 69 || c === 101) && !h && (c = this.input.charCodeAt(++this.state.pos), (c === 43 || c === 45) && ++this.state.pos, this.readInt(10) === null && this.raise(p.InvalidOrMissingExponent, s), i = true, o = true, c = this.input.charCodeAt(this.state.pos)), c === 110 && ((i || l) && this.raise(p.InvalidBigIntLiteral, s), ++this.state.pos, r = true), c === 109 && (this.expectPlugin("decimal", this.state.curPosition()), (o || l) && this.raise(p.InvalidDecimal, s), ++this.state.pos, n = true), j(this.codePointAtPos(this.state.pos))) throw this.raise(p.NumberIdentifier, this.state.curPosition());
        ...
        var Wi = /\*?\s*@((?:no)?flow)\b/, Ji = (a) => class extends a {
          ...
          flowEnumParseExplicitType({ enumName: e }) {
            ...
            if (!S(this.state.type)) throw this.raise(g.EnumInvalidExplicitTypeUnknownSupplied, this.state.startLoc, { enumName: e });
...
`) : i = String.fromCharCode(s), ++this.state.curLine, this.state.lineStart = this.state.pos, i;
          ...
          updateContext(e) {
            ...
            if (i === 56 && e === 142) s.splice(-2, 2, w.j_cTag), this.state.canStartJSXElement = false;
        ...
        var tr = (a) => class extends a {
          ...
          parseTypeOnlyImportExportSpecifier(e, s, i) {
            ...
            if (this.isContextual(93)) {
              ...
              } else M(this.state.type) ? (c = false, h = s ? this.parseIdentifier() : this.parseModuleExportName()) : (l = true, o = d);
        ...
        var zt = $`placeholders`({ ClassNameIsRequired: "A class name is required.", UnexpectedSpace: "Unexpected space in placeholder." }), ar = (a) => class extends a {
          ...
          isExportDefaultSpecifier() {
            if (this.match(65)) {
              let e = this.nextTokenStart();
              if (this.isUnparsedContextual(e, "from") && this.input.startsWith(H(144), this.nextTokenStartSince(e + 4))) return true;
            }
        ...
        var ut = class extends pt {
          ...
          parseExprOp(t, e, s) {
            ...
            if (yi(i) && (this.prodParam.hasIn || !this.match(58))) {
              ...
              if (r > s) {
                ...
                if (h && (r = Ne(42)), this.next(), i === 39 && this.hasPlugin(["pipelineOperator", { proposal: "minimal" }]) && this.state.type === 96 && this.prodParam.hasAwait) throw this.raise(p.UnexpectedAwaitAfterPipelineBody, this.state.startLoc);
          ...
          finishTopicReference(t, e, s, i) {
            ...
            } else throw this.raise(p.PipeTopicUnconfiguredToken, e, { token: H(i) });
          }
...
`), cooked: r === null ? null : r.slice(1, l) }, o.tail = h, this.next();
          ...
          parseObjectProperty(t, e, s, i) {
            ...
            if (!t.computed && t.key.type === "Identifier") {
              if (this.checkReservedWord(t.key.name, t.key.loc.start, true, false), s) t.value = this.parseMaybeDefault(e, V(t.key));
          ...
          isExportDefaultSpecifier() {
            ...
            if (S(t)) {
              ...
              if ((t === 130 || t === 129) && !this.state.containsEsc) {
                ...
                if (S(i) && i !== 98 || i === 5) return this.expectOnePlugin(["flow", "typescript"]), false;
              }
